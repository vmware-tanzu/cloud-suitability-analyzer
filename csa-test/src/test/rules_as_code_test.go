...
// 	exportYML(t, testName, rule, targetFilePath, expectedMatch, expectedMatchCount, expectedValue)
// }

// func exportYML(t *testing.T, testName string, rule model.Rule, targetFilePath string, expectedMatch bool, expectedMatchCount int, expectedValue string) {
// 	t.Log("- name: \"" + testName + "\"")
// 	t.Log("  rule-name: " + rule.Name)
// 	t.Log("  test-filename: " + targetFilePath)
// 	t.Log("  assert: ", expectedMatch)
// 	t.Log("  assert-count: ", expectedMatchCount)
// 	t.Log("  assert-value: \"" + expectedValue + "\"")
