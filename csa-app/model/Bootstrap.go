...
func BootstrapRules() []Rule {
    var BootstrapRules = []Rule{
            ...
            { Name: "SNAP-build-Gradle", RuleType: "standard", Level: "", FileType: "gradle$", Target: "file", Type: "simple-text", DefaultPattern: "", Advice: "Gradle is being used", Effort: 0, Readiness: 0, Impact: "", Category: "buildSystem", Criticality: "medium",Container: 50, Cloud: 50,
            Tags:
            ...
            { Name: "SNAP-SQL-properties", RuleType: "standard", Level: "", FileType: "properties$", Target: "line", Type: "regex", DefaultPattern: "^.*[ .]%s[ (].*", Advice: "Database coupling detected consider using ORM framework", Effort: 10, Readiness: 0, Impact: "", Category: "jdbc", Criticality: "medium",Container: 50, Cloud: 50,
            Tags:
            ...
            { Name: "SNAP-SQL", RuleType: "standard", Level: "", FileType: "java$", Target: "line", Type: "regex", DefaultPattern: "^.*[ .]%s[ (].*", Advice: "Database coupling detected consider using ORM framework", Effort: 10, Readiness: 0, Impact: "", Category: "jdbc", Criticality: "medium",Container: 50, Cloud: 50,
            Tags:
            []Tag{  { Value: "jdbc",}, { Value: "sql",}, { Value: "snap",}, },
            Profiles:
            []Profile{  { Value: "cloud-suitability",}, },
            ...
            { Name: "SNAP-java-package-GradleJar", RuleType: "standard", Level: "", FileType: "gradle$", Target: "line", Type: "regex", DefaultPattern: "[{] *%s", Advice: "Executable jar packaging is used", Effort: 0, Readiness: 0, Impact: "", Category: "packaging", Criticality: "medium",Container: 50, Cloud: 50,
            Tags:
            []Tag{  { Value: "gradle",}, { Value: "snap",}, },
            Profiles:
            []Profile{  { Value: "cloud-suitability",}, },
            ...
            { Name: "java-RDS-connection-string-user-password-properties", RuleType: "standard", Level: "Info", FileType: "properties$", Target: "line", Type: "regex", DefaultPattern: "", Advice: "relational database service connection string, username or password are detected", Effort: 0, Readiness: 0, Impact: "", Category: "relational database service", Criticality: "medium",Container: 50, Cloud: 50,
            Tags:
            ...
            { Name: "java-apm-dependency-maven", RuleType: "standard", Level: "Info", FileType: "xml$", Target: "file", Type: "xpath", DefaultPattern: "", Advice: "The application has integrated an Application Performance Management (APM) tool as a dependency", Effort: 0, Readiness: 0, Impact: "", Category: "apm", Criticality: "medium",Container: 50, Cloud: 50,
            Tags:
            []Tag{  { Value: "apm",}, },
            Profiles:
            []Profile{  },
            ...
            { Name: "java-mq-connection-string-user-password-properties", RuleType: "standard", Level: "Info", FileType: "properties$", Target: "line", Type: "regex", DefaultPattern: "", Advice: "Message queue connection string, username or password are detected", Effort: 0, Readiness: 0, Impact: "", Category: "message queue", Criticality: "medium",Container: 50, Cloud: 50,
            Tags:
            ...
            { Name: "java-non-lts-version-gradle", RuleType: "standard", Level: "Warn", FileType: "gradle$|kts$", Target: "line", Type: "regex", DefaultPattern: "(^|\\.|\\s)targetCompatibility(\\s|=)[^\\d]+(%s)", Advice: "The application is using non-LTS version Java. JDK on LTS version is recommended, i.e., JAVA_8, JAVA_11 or JAVA_17.", Effort: 6, Readiness: 0, Impact: "", Category: "version", Criticality: "medium",Container: 50, Cloud: 50,
            Tags:
            ...
            { Name: "java-properties-config-client-configs", RuleType: "standard", Level: "Info", FileType: "properties$", Target: "line", Type: "regex", DefaultPattern: "", Advice: "The application is using spring config server and setting the connection string", Effort: 0, Readiness: 0, Impact: "", Category: "config server", Criticality: "medium",Container: 50, Cloud: 50,
            Tags:
            ...
            { Name: "java-properties-eureka-client-configs", RuleType: "standard", Level: "Info", FileType: "properties$", Target: "line", Type: "regex", DefaultPattern: "", Advice: "The application is using eureka and setting the connection string", Effort: 0, Readiness: 0, Impact: "", Category: "eureka", Criticality: "medium",Container: 50, Cloud: 50,
            Tags:
            []Tag{  { Value: "eureka",}, },
            Profiles:
            []Profile{  },
            ...
            { Name: "java-properties-logging-console-appender", RuleType: "standard", Level: "Warn", FileType: "xml$", Target: "contents", Type: "regex", DefaultPattern: "", Advice: "Please enable logging to console", Effort: 5, Readiness: 0, Impact: "", Category: "logging", Criticality: "medium",Container: 50, Cloud: 50,
            Tags:
            []Tag{  { Value: "logging",}, },
            Profiles:
            []Profile{  },
            ...
            { Name: "java-redis-connection-string-user-password-properties", RuleType: "standard", Level: "Info", FileType: "properties$", Target: "line", Type: "regex", DefaultPattern: "", Advice: "Redis connection string, username and password are detected", Effort: 0, Readiness: 0, Impact: "", Category: "redis", Criticality: "medium",Container: 50, Cloud: 50,
            Tags:
            []Tag{  { Value: "redis",}, },
            Profiles:
            []Profile{  },
            ...
            { Name: "java-redis-connection-string-user-password-yaml", RuleType: "standard", Level: "Info", FileType: "yaml$|yml$", Target: "contents", Type: "yamlpath", DefaultPattern: "", Advice: "Redis connection string, username and password are detected", Effort: 0, Readiness: 0, Impact: "", Category: "redis", Criticality: "medium",Container: 50, Cloud: 50,
            Tags:
            []Tag{  { Value: "redis",}, },
            Profiles:
            []Profile{  },
            ...
            { Name: "java-spring-boot-starter", RuleType: "standard", Level: "Info", FileType: "gradle$|kts$|xml$", Target: "contents", Type: "regex", DefaultPattern: "", Advice: "The application has spring boot/spring cloud starter dependencies", Effort: 0, Readiness: 0, Impact: "", Category: "spring boot", Criticality: "medium",Container: 50, Cloud: 50,
            Tags:
            []Tag{  { Value: "spring boot",}, },
            Profiles:
            []Profile{  },
            ...
            { Name: "java-spring-boot-version-gradle", RuleType: "standard", Level: "Critical", FileType: "gradle$|kts$", Target: "line", Type: "regex", DefaultPattern: "", Advice: "Spring boot version is too low", Effort: 50, Readiness: 0, Impact: "", Category: "version", Criticality: "medium",Container: 50, Cloud: 50,
            Tags:
            []Tag{  { Value: "spring boot",}, },
            Profiles:
            []Profile{  },
            ...
            { Name: "java-spring-boot-version-maven", RuleType: "standard", Level: "Critical", FileType: "xml$", Target: "contents", Type: "xpath", DefaultPattern: "//*[groupId=\"org.springframework.boot\" and starts-with(version,\"%s\")]/version", Advice: "Spring boot version is too low", Effort: 50, Readiness: 0, Impact: "", Category: "version", Criticality: "medium",Container: 50, Cloud: 50,
            Tags:
            []Tag{  { Value: "spring boot",}, },
            Profiles:
            []Profile{  },
            ...
            { Name: "java-spring-cloud-support-version-maven", RuleType: "standard", Level: "Warn", FileType: "xml$", Target: "contents", Type: "xpath", DefaultPattern: "", Advice: "Spring cloud version is out of any support. Please update to newer version", Effort: 6, Readiness: 0, Impact: "", Category: "version", Criticality: "medium",Container: 50, Cloud: 50,
            Tags:
            []Tag{  { Value: "spring cloud",}, },
            Profiles:
            []Profile{  },
            ...
            { Name: "java-spring-cloud-version-gradle", RuleType: "standard", Level: "Critical", FileType: "gradle$|kts$", Target: "line", Type: "regex", DefaultPattern: "(?i)(springCloudVersion|org\\.springframework\\.cloud)(.*)(%s)", Advice: "Spring cloud version is too low", Effort: 50, Readiness: 0, Impact: "", Category: "version", Criticality: "medium",Container: 50, Cloud: 50,
            Tags:
            []Tag{  { Value: "spring cloud",}, },
            Profiles:
            []Profile{  },
            ...
            { Name: "java-spring-cloud-version-maven", RuleType: "standard", Level: "Critical", FileType: "xml$", Target: "contents", Type: "xpath", DefaultPattern: "", Advice: "Spring cloud version is too low", Effort: 50, Readiness: 0, Impact: "", Category: "version", Criticality: "medium",Container: 50, Cloud: 50,
            Tags:
            []Tag{  { Value: "spring cloud",}, },
            Profiles:
            []Profile{  },
            ...
            { Name: "java-version-gradle", RuleType: "standard", Level: "Critical", FileType: "gradle$|kts$", Target: "line", Type: "regex", DefaultPattern: "(^|\\.|\\s)targetCompatibility(\\s|=)[^\\d]+(%s)", Advice: "JDK version is found to be lower than JAVA_8", Effort: 50, Readiness: 0, Impact: "", Category: "version", Criticality: "medium",Container: 50, Cloud: 50,
            Tags:
            []Tag{  { Value: "java version",}, },
            Profiles:
            []Profile{  },
            ...
            { Name: "java-version-maven", RuleType: "standard", Level: "Critical", FileType: "xml$", Target: "contents", Type: "xpath", DefaultPattern: "//*[starts-with(java.version,\"%s\")]/java.version", Advice: "JDK version is found to be lower than JAVA_8", Effort: 50, Readiness: 0, Impact: "", Category: "java", Criticality: "medium",Container: 50, Cloud: 50,
            Tags:
            []Tag{  { Value: "java version",}, },
            Profiles:
            []Profile{  },
            ...
            { Name: "java-xml-logging-console-appender", RuleType: "standard", Level: "Warn", FileType: "xml$", Target: "contents", Type: "regex", DefaultPattern: "", Advice: "Please enable logging to console", Effort: 5, Readiness: 0, Impact: "", Category: "logging", Criticality: "medium",Container: 50, Cloud: 50,
            Tags:
            []Tag{  { Value: "logging",}, },
            Profiles:
            []Profile{  },
            ...
            { Name: "java-yaml-config-client-configs", RuleType: "standard", Level: "Info", FileType: "(yaml$|yml$)", Target: "contents", Type: "yamlpath", DefaultPattern: "", Advice: "The application is using spring config server and setting the connection string", Effort: 0, Readiness: 0, Impact: "", Category: "config server", Criticality: "medium",Container: 50, Cloud: 50,
            Tags:
            []Tag{  { Value: "config server",}, },
            Profiles:
            []Profile{  },
            ...
            { Name: "java-yaml-eureka-client-configs", RuleType: "standard", Level: "Info", FileType: "(yaml$|yml$)", Target: "contents", Type: "yamlpath", DefaultPattern: "", Advice: "The application is using eureka and setting the connection string", Effort: 0, Readiness: 0, Impact: "", Category: "eureka", Criticality: "medium",Container: 50, Cloud: 50,
            Tags:
            []Tag{  { Value: "eureka",}, },
            Profiles:
            []Profile{  },
            ...
            { Name: "java-yaml-json-log4j2-fileAppender", RuleType: "standard", Level: "Warn", FileType: "yaml$|yml$|json$|jsn$", Target: "file", Type: "yamlpath", DefaultPattern: "", Advice: "Replace file appender with console appender", Effort: 3, Readiness: 0, Impact: "", Category: "logging", Criticality: "medium",Container: 50, Cloud: 50,
            Tags:
            ...
            { Name: "java-yamljson-logging-console-appender", RuleType: "standard", Level: "Warn", FileType: "yaml$|yml$|json$|jsn$", Target: "file", Type: "yamlpath", DefaultPattern: "", Advice: "Please enable logging to console", Effort: 5, Readiness: 0, Impact: "", Category: "logging", Criticality: "medium",Container: 50, Cloud: 50,
            Tags:
            []Tag{  { Value: "logging",}, },
            Profiles:
            []Profile{  },
            ...
            { Name: "properties-port", RuleType: "standard", Level: "Info", FileType: "properties$", Target: "line", Type: "regex", DefaultPattern: "", Advice: "The application is setting the server port. Please be aware of potential port reliance issues during the migration process", Effort: 0, Readiness: 0, Impact: "", Category: "port", Criticality: "medium",Container: 50, Cloud: 50,
            Tags:
            []Tag{  { Value: "port",}, },
            Profiles:
            []Profile{  },
            ...
            { Name: "windows-dynamic-link-library", RuleType: "standard", Level: "Critical", FileType: "dll$", Target: "file", Type: "regex", DefaultPattern: "", Advice: "This Dynamic-Link Library is Microsoft Windows platform dependent. It needs to be replaced with a Linux-style shared library", Effort: 10, Readiness: 0, Impact: "", Category: "os", Criticality: "medium",Container: 50, Cloud: 50,
            Tags:
            []Tag{  { Value: "os",}, },
            Profiles:
            []Profile{  },
            ...
            { Name: "bootCDI", RuleType: "standard", Level: "", FileType: "xml$", Target: "line", Type: "regex", DefaultPattern: "(%s)", Advice: "Automatic remediation with Bootifier", Effort: 2, Readiness: 2, Impact: "", Category: "cdi", Criticality: "medium",Container: 50, Cloud: 50,
            Tags:
            ...
            { Name: "bootEJB", RuleType: "standard", Level: "", FileType: "xml$", Target: "line", Type: "regex", DefaultPattern: "(%s)", Advice: "Automatic remediation with Bootifier", Effort: 2, Readiness: 2, Impact: "", Category: "ejb", Criticality: "medium",Container: 50, Cloud: 50,
            Tags:
            ...
            { Name: "bootJAXWS", RuleType: "standard", Level: "", FileType: "xml$", Target: "line", Type: "regex", DefaultPattern: "(%s)", Advice: "Automatic remediation with Bootifier", Effort: 2, Readiness: 2, Impact: "", Category: "jaxws", Criticality: "medium",Container: 50, Cloud: 50,
            Tags:
            ...
            { Name: "bootJDBC", RuleType: "standard", Level: "", FileType: "java$", Target: "line", Type: "regex", DefaultPattern: "^.*import(\\s*|=\")%s.*$", Advice: "Consult 3rd party documentation", Effort: 0, Readiness: 5, Impact: "", Category: "persistence", Criticality: "medium",Container: 50, Cloud: 50,
            Tags:
            ...
            { Name: "bootJSF", RuleType: "standard", Level: "", FileType: "xml$", Target: "line", Type: "regex", DefaultPattern: "(%s)", Advice: "Automatic remediation with Bootifier", Effort: 2, Readiness: 2, Impact: "", Category: "jsf", Criticality: "medium",Container: 50, Cloud: 50,
            Tags:
            ...
            { Name: "bootMDB", RuleType: "standard", Level: "", FileType: "xml$", Target: "line", Type: "regex", DefaultPattern: "(%s)", Advice: "Automatic remediation with Bootifier", Effort: 2, Readiness: 2, Impact: "", Category: "mdb", Criticality: "medium",Container: 50, Cloud: 50,
            Tags:
            ...
            { Name: "bootSTRUTS", RuleType: "standard", Level: "", FileType: "xml$", Target: "line", Type: "regex", DefaultPattern: "(%s)", Advice: "Automatic remediation with Bootifier", Effort: 2, Readiness: 2, Impact: "", Category: "struts", Criticality: "medium",Container: 50, Cloud: 50,
            Tags:
            []Tag{  { Value: "struts",}, },
            Profiles:
            []Profile{  { Value: "cloud-suitability",}, },
            ...
            { Name: "bootTXN", RuleType: "standard", Level: "", FileType: "xml$", Target: "line", Type: "regex", DefaultPattern: "(%s)", Advice: "Automatic remediation with Bootifier", Effort: 2, Readiness: 2, Impact: "", Category: "txn", Criticality: "medium",Container: 50, Cloud: 50,
            Tags:
            ...
            { Name: "bootWEBSOCKET", RuleType: "standard", Level: "", FileType: "xml$", Target: "line", Type: "regex", DefaultPattern: "(%s)", Advice: "Automatic remediation with Bootifier", Effort: 0, Readiness: 2, Impact: "", Category: "WebServlet", Criticality: "medium",Container: 50, Cloud: 50,
            Tags:
            ...
            { Name: "config-dotnet-webConfig", RuleType: "standard", Level: "", FileType: "config$", Target: "file", Type: "simple-text", DefaultPattern: "", Advice: "Upgrade to .Net Core", Effort: 0, Readiness: 0, Impact: "", Category: "Config", Criticality: "medium",Container: 50, Cloud: 50,
            Tags:
            ...
            { Name: "docker-dockerFile", RuleType: "standard", Level: "", FileType: "$", Target: "file", Type: "simple-text", DefaultPattern: "", Advice: "Determine if TKG is more prescriptive and TBS or Choreographer can be used to containerize", Effort: 5, Readiness: 1000, Impact: "", Category: "docker", Criticality: "medium",Container: 50, Cloud: 50,
            Tags:
            ...
            { Name: "docker-non-root-user", RuleType: "standard", Level: "", FileType: "$", Target: "line", Type: "regex", DefaultPattern: "^%s", Advice: "Shows evidence of avoiding root privledges", Effort: -100, Readiness: 1000, Impact: "", Category: "dockerSecurity", Criticality: "medium",Container: 50, Cloud: 50,
            Tags:
            ...
            { Name: "docker-sudo", RuleType: "standard", Level: "", FileType: "$", Target: "line", Type: "regex", DefaultPattern: "^%s", Advice: "Using root inside a container is a serious vulnerability.", Effort: 100, Readiness: 10, Impact: "", Category: "docker", Criticality: "medium",Container: 50, Cloud: 50,
            Tags:
            ...
            { Name: "dotnet-RequestFilteringModule", RuleType: "standard", Level: "", FileType: "config$", Target: "file", Type: "xpath", DefaultPattern: "", Advice: "Refer to platform documentation", Effort: 100, Readiness: 1, Impact: "", Category: "unsupported-iis-module", Criticality: "medium",Container: 50, Cloud: 50,
            Tags:
            ...
            { Name: "dotnet-db2-unmanaged", RuleType: "standard", Level: "", FileType: "(cs$|vb$)", Target: "line", Type: "regex", DefaultPattern: ".*\\s*%s$", Advice: "Refer to platform documentation", Effort: 10, Readiness: 9, Impact: "", Category: "database", Criticality: "medium",Container: 50, Cloud: 50,
            Tags:
            []Tag{  { Value: "database",}, },
            Profiles:
            []Profile{  { Value: "cloud-suitability",}, },
            ...
            { Name: "dotnet-serilog-elasticsearch", RuleType: "standard", Level: "", FileType: "(cs|yaml|yml|json)", Target: "line", Type: "regex", DefaultPattern: ".*%s.*", Advice: "Make sure to have reachable ELK stack from deployed app", Effort: 5, Readiness: 8, Impact: "", Category: "logging", Criticality: "medium",Container: 50, Cloud: 50,
            Tags:
            ...
            { Name: "dotnet-file-based-config", RuleType: "standard", Level: "", FileType: "cs", Target: "line", Type: "regex", DefaultPattern: ".*%s.*", Advice: "Externalize configuration to environment or use ConfigMap as file-mount into a K8S pod", Effort: 10, Readiness: 3, Impact: "", Category: "env-config", Criticality: "medium",Container: 50, Cloud: 50,
            Tags:
            ...
            { Name: "dotnet-fileIO-read", RuleType: "standard", Level: "", FileType: "(cs$|vb$)", Target: "line", Type: "regex", DefaultPattern: ".*%s*\\(.*", Advice: "Relying on the local filesystem to store state is unreliable in a cloud platform.", Effort: 3, Readiness: 8, Impact: "", Category: "io", Criticality: "medium",Container: 50, Cloud: 50,
            Tags:
            []Tag{  { Value: "io",}, },
            Profiles:
            []Profile{  { Value: "cloud-suitability",}, },
            ...
            { Name: "dotnet-oracle-umanaged", RuleType: "standard", Level: "", FileType: "(cs$|vb$)", Target: "line", Type: "regex", DefaultPattern: ".*%s.*", Advice: "Oracle unmanaged driver requires including binaries with app", Effort: 3, Readiness: 8, Impact: "", Category: "database", Criticality: "medium",Container: 50, Cloud: 50,
            Tags:
            ...
            { Name: "dotnet-sharepoint", RuleType: "standard", Level: "", FileType: "(cs$|vb$)", Target: "line", Type: "regex", DefaultPattern: ".*%s.*", Advice: "SharePoint is not supported on CloudFoundry.", Effort: 100, Readiness: 0, Impact: "", Category: "unsupported-module", Criticality: "medium",Container: 50, Cloud: 50,
            Tags:
            ...
            { Name: "dotnet-wcf-bindings", RuleType: "standard", Level: "", FileType: "config$", Target: "line", Type: "regex", DefaultPattern: "", Advice: "Refers to documentation when using WCF, some protocols might not be supported", Effort: 0, Readiness: 0, Impact: "", Category: "wcf", Criticality: "medium",Container: 50, Cloud: 50,
            Tags:
            ...
            { Name: "dotnet-wcf-ssl", RuleType: "standard", Level: "", FileType: "(cs$|vb$)", Target: "line", Type: "regex", DefaultPattern: ".*%s.*", Advice: "When using HTTPS, terminate SSL at load balancer", Effort: 1, Readiness: 10, Impact: "", Category: "wcf", Criticality: "medium",Container: 50, Cloud: 50,
            Tags:
            ...
            { Name: "dotnet-windows-code-access-security", RuleType: "standard", Level: "", FileType: "(cs$|vb$)", Target: "line", Type: "regex", DefaultPattern: ".*%s.*", Advice: "unsupported", Effort: 10, Readiness: 9, Impact: "", Category: "security", Criticality: "medium",Container: 50, Cloud: 50,
            Tags:
            []Tag{  { Value: "security",}, },
            Profiles:
            []Profile{  { Value: "cloud-suitability",}, },
            ...
            { Name: "java-3rdPartyImports", RuleType: "standard", Level: "", FileType: "(jsp$|java$)", Target: "line", Type: "regex", DefaultPattern: "^.*import(\\s*|=\")%s.*$", Advice: "Consult 3rd party documentation", Effort: 0, Readiness: 0, Impact: "", Category: "third-party", Criticality: "medium",Container: 50, Cloud: 50,
            Tags:
            ...
            { Name: "java-3rdPartySecurity-import", RuleType: "standard", Level: "", FileType: "(jsp$|java$)", Target: "line", Type: "regex", DefaultPattern: "^.*import(\\s*|=\")%s.*$", Advice: "Consult 3rd party documentation", Effort: 7, Readiness: 10, Impact: "", Category: "security", Criticality: "medium",Container: 50, Cloud: 50,
            Tags:
            []Tag{  { Value: "security",}, },
            Profiles:
            []Profile{  { Value: "cloud-suitability",}, },
            ...
            { Name: "java-MBeans", RuleType: "standard", Level: "", FileType: "java$", Target: "line", Type: "regex", DefaultPattern: "(%s)\\:{1}", Advice: "MBean is application server specific, change to refactor using cloud friendly technology", Effort: 100, Readiness: 10, Impact: "", Category: "websphere", Criticality: "medium",Container: 50, Cloud: 50,
            Tags:
            ...
            { Name: "java-processexit", RuleType: "standard", Level: "", FileType: "java$", Target: "line", Type: "regex", DefaultPattern: "^.*[.]%s[ (].*$", Advice: "Refer to IBM documentation", Effort: 9, Readiness: 10, Impact: "", Category: "process-exit", Criticality: "medium",Container: 50, Cloud: 50,
            Tags:
            ...
            { Name: "java-activemq", RuleType: "standard", Level: "", FileType: "java$", Target: "line", Type: "regex", DefaultPattern: ".*[ .]%s[ (].*", Advice: "Remediate any persistence issues", Effort: 7, Readiness: 7, Impact: "", Category: "activemq", Criticality: "medium",Container: 50, Cloud: 50,
            Tags:
            ...
            { Name: "java-alarmD-import", RuleType: "standard", Level: "", FileType: "(jsp$|java$)", Target: "line", Type: "regex", DefaultPattern: "^.*import(\\s*|=\")%s.*$", Advice: "Integrate with new alarmD service or migrate to Spring Boot scheduler", Effort: 5, Readiness: 0, Impact: "", Category: "ThirdParty", Criticality: "medium",Container: 50, Cloud: 50,
            Tags:
            ...
            { Name: "java-apacheFop-import", RuleType: "standard", Level: "", FileType: "java$", Target: "line", Type: "regex", DefaultPattern: "[ .]%s[ .({]", Advice: "Usage requires configuration remdiation", Effort: 5, Readiness: 10, Impact: "", Category: "thirdParty", Criticality: "medium",Container: 50, Cloud: 50,
            Tags:
            ...
            { Name: "java-batch", RuleType: "standard", Level: "", FileType: "java$", Target: "line", Type: "regex", DefaultPattern: "^.*[ .]%s[ (].*", Advice: "Remove jndi provider or move to TKG", Effort: 10, Readiness: 7, Impact: "", Category: "jndi", Criticality: "medium",Container: 50, Cloud: 50,
            Tags:
            ...
            { Name: "java-batchAnnotations", RuleType: "standard", Level: "", FileType: "java$", Target: "line", Type: "regex", DefaultPattern: "^.*@%s$", Advice: "Batch processing can include long running processes consider using k8s job scheduler", Effort: 10, Readiness: 7, Impact: "", Category: "batch", Criticality: "medium",Container: 50, Cloud: 50,
            Tags:
            []Tag{  { Value: "batch",}, },
            Profiles:
            []Profile{  { Value: "cloud-suitability",}, },
            ...
            { Name: "java-cache-dist-import", RuleType: "standard", Level: "", FileType: "(jsp$|java$)", Target: "line", Type: "regex", DefaultPattern: "^.*import(\\s*|=\")%s.*$", Advice: "Distributed caches must be remediated to function in K8S", Effort: 50, Readiness: 10, Impact: "", Category: "distcache", Criticality: "medium",Container: 50, Cloud: 50,
            Tags:
            ...
            { Name: "java-corba", RuleType: "standard", Level: "", FileType: "java$", Target: "line", Type: "regex", DefaultPattern: ".*[ .]%s[ (].*", Advice: "Replace with cloud-friendly framework or move to TKG", Effort: 10, Readiness: 6, Impact: "", Category: "corba", Criticality: "medium",Container: 50, Cloud: 50,
            Tags:
            ...
            { Name: "java-ehcache", RuleType: "standard", Level: "", FileType: "java$", Target: "line", Type: "regex", DefaultPattern: "^.*import(\\s*|=\")%s.*$", Advice: "Consider to externalize cache if not already", Effort: 100, Readiness: 6, Impact: "", Category: "cache", Criticality: "medium",Container: 50, Cloud: 50,
            Tags:
            ...
            { Name: "java-ejb-invocation", RuleType: "standard", Level: "", FileType: "java$", Target: "line", Type: "regex", DefaultPattern: "^.*@%s.*$", Advice: "Refer to platform documentation", Effort: 7, Readiness: 10, Impact: "", Category: "ejb", Criticality: "medium",Container: 50, Cloud: 50,
            Tags:
            ...
            { Name: "java-ejb-mdb", RuleType: "standard", Level: "", FileType: "java$", Target: "line", Type: "regex", DefaultPattern: "^.*import(\\s*|=\")%s.*$", Advice: "Consult MDB documentation", Effort: 7, Readiness: 7, Impact: "", Category: "ejb", Criticality: "medium",Container: 50, Cloud: 50,
            Tags:
            ...
            { Name: "java-ejb-rmi", RuleType: "standard", Level: "", FileType: "java$", Target: "line", Type: "regex", DefaultPattern: "^.*[ .]%s[ (].*", Advice: "Removing RMI calls from client applications.", Effort: 10, Readiness: 4, Impact: "", Category: "ejb", Criticality: "medium",Container: 50, Cloud: 50,
            Tags:
            ...
            { Name: "java-ejb-stateful-import", RuleType: "standard", Level: "", FileType: "java$", Target: "line", Type: "regex", DefaultPattern: "^.*import(\\s*|=\")%s.*$", Advice: "Refer to platform documentation", Effort: 7, Readiness: 7, Impact: "", Category: "ejb", Criticality: "medium",Container: 50, Cloud: 50,
            Tags:
            ...
            { Name: "java-ejb-stateful", RuleType: "standard", Level: "", FileType: "java$", Target: "line", Type: "regex", DefaultPattern: "^.*@%s$", Advice: "Refer EJB stateful/stateless documentation", Effort: 100, Readiness: 100, Impact: "", Category: "ejb", Criticality: "medium",Container: 50, Cloud: 50,
            Tags:
            ...
            { Name: "java-ejb-stateless", RuleType: "standard", Level: "", FileType: "java$", Target: "line", Type: "regex", DefaultPattern: "^.*[ .]%s[ (].*", Advice: "Removing RMI calls from client applications.", Effort: 10, Readiness: 4, Impact: "", Category: "ejb", Criticality: "medium",Container: 50, Cloud: 50,
            Tags:
            []Tag{  { Value: "ejb",}, { Value: "stateless",}, },
            Profiles:
            []Profile{  { Value: "cloud-suitability",}, },
            ...
            { Name: "java-faces-flow-Annotations", RuleType: "standard", Level: "", FileType: "java$", Target: "line", Type: "regex", DefaultPattern: "^.*@%s$", Advice: "Batch processing can include long running processes", Effort: 10, Readiness: 7, Impact: "", Category: "batch", Criticality: "medium",Container: 50, Cloud: 50,
            Tags:
            ...
            { Name: "java-faces-flow", RuleType: "standard", Level: "", FileType: "java$", Target: "line", Type: "regex", DefaultPattern: "^.*[ .]%s[ (].*", Advice: "Review usage to determine how the customized state of JSF flow is being used and determined if it can be externalized.", Effort: 10, Readiness: 10, Impact: "", Category: "jsf-flow", Criticality: "medium",Container: 50, Cloud: 50,
            Tags:
            []Tag{  { Value: "jsf-flow",}, { Value: "jsf",}, },
            Profiles:
            []Profile{  { Value: "cloud-suitability",}, },
            ...
            { Name: "java-fileIO", RuleType: "standard", Level: "", FileType: "java$", Target: "line", Type: "regex", DefaultPattern: "^.*[ .]%s[ (].*", Advice: "Move to cloud friendly alternative storage service", Effort: 8, Readiness: 8, Impact: "", Category: "io", Criticality: "medium",Container: 50, Cloud: 50,
            Tags:
            ...
            { Name: "java-file-system", RuleType: "standard", Level: "", FileType: "java$", Target: "line", Type: "regex", DefaultPattern: "(%s)\\:{1}\\/{2}", Advice: "Use backing storage service", Effort: 100, Readiness: 10, Impact: "", Category: "io", Criticality: "medium",Container: 50, Cloud: 50,
            Tags:
            []Tag{  { Value: "io",}, },
            Profiles:
            []Profile{  { Value: "cloud-suitability",}, },
            ...
            { Name: "java-glassfish-import", RuleType: "standard", Level: "", FileType: "java$", Target: "line", Type: "regex", DefaultPattern: "^import\\s*%s.*", Advice: "Refer to Weblogic documentation", Effort: 100, Readiness: 10, Impact: "", Category: "oracle", Criticality: "medium",Container: 50, Cloud: 50,
            Tags:
            []Tag{  { Value: "glassfish",}, },
            Profiles:
            []Profile{  { Value: "cloud-suitability",}, },
            ...
            { Name: "java-handles-term", RuleType: "standard", Level: "", FileType: "java$", Target: "line", Type: "regex", DefaultPattern: "^.*%s", Advice: "For containerization, the TERM signal must be handled, this pattern is a positive finding.", Effort: 1, Readiness: 6, Impact: "", Category: "term-signal", Criticality: "medium",Container: 50, Cloud: 50,
            Tags:
            []Tag{  { Value: "term",}, },
            Profiles:
            []Profile{  { Value: "cloud-suitability",}, },
            ...
            { Name: "java-hardIP", RuleType: "standard", Level: "", FileType: "java$", Target: "line", Type: "regex", DefaultPattern: "%s", Advice: "Hardcoded IP addresses are problematic in K8S", Effort: 1, Readiness: 8, Impact: "", Category: "hard-ip", Criticality: "medium",Container: 50, Cloud: 50,
            Tags:
            []Tag{  { Value: "hard-ip",}, },
            Profiles:
            []Profile{  { Value: "cloud-suitability",}, },
            ...
            { Name: "java-hazelcast", RuleType: "standard", Level: "", FileType: "java$", Target: "line", Type: "regex", DefaultPattern: "^.*[ .]%s[ ({.<].*", Advice: "Make sure Cache instance is externalized", Effort: 100, Readiness: 6, Impact: "", Category: "cache", Criticality: "medium",Container: 50, Cloud: 50,
            Tags:
            ...
            { Name: "java-iop", RuleType: "standard", Level: "", FileType: "java$", Target: "line", Type: "regex", DefaultPattern: "^.*[ .]%s[ (.].*", Advice: "Remote Method Invocations create coupling between componets. Move to cloud friendly alternatives such as REST endpoints.", Effort: 3, Readiness: 6, Impact: "", Category: "iop", Criticality: "medium",Container: 50, Cloud: 50,
            Tags:
            ...
            { Name: "java-java-fx-import", RuleType: "standard", Level: "", FileType: "java$", Target: "line", Type: "regex", DefaultPattern: "^import\\s*%s.*", Advice: "Java-fx is not cloud compatible and requires the JRE on the remote device.", Effort: 1000, Readiness: 100, Impact: "", Category: "java-fx", Criticality: "medium",Container: 50, Cloud: 50,
            Tags:
            []Tag{  { Value: "java-fx",}, },
            Profiles:
            []Profile{  { Value: "cloud-suitability",}, },
            ...
            { Name: "java-jaxrs-import", RuleType: "standard", Level: "", FileType: "(jsp$|java$)", Target: "line", Type: "regex", DefaultPattern: "^.*import(\\s*|=\")%s.*$", Advice: "Refer to platform documentation", Effort: 1, Readiness: 8, Impact: "", Category: "jax-rs", Criticality: "medium",Container: 50, Cloud: 50,
            Tags:
            ...
            { Name: "java-jcaAnnotations", RuleType: "standard", Level: "", FileType: "java$", Target: "line", Type: "regex", DefaultPattern: "^.*@%s$", Advice: "Convert to a cloud friendly backing service.", Effort: 100, Readiness: 7, Impact: "", Category: "jca", Criticality: "medium",Container: 50, Cloud: 50,
            Tags:
            ...
            { Name: "java-jcache", RuleType: "standard", Level: "", FileType: "java$", Target: "line", Type: "regex", DefaultPattern: "^.*[ .]%s[ ({.<].*", Advice: "Make sure its externalized and using Cloud Friendly cache implementation.", Effort: 50, Readiness: 6, Impact: "", Category: "cache", Criticality: "medium",Container: 50, Cloud: 50,
            Tags:
            ...
            { Name: "java-jersey-import", RuleType: "standard", Level: "", FileType: "java$", Target: "line", Type: "regex", DefaultPattern: "^import\\s*%s.*", Advice: "Refer to 3rd party organization for cloud affinity of library", Effort: 5, Readiness: 8, Impact: "", Category: "jersey", Criticality: "medium",Container: 50, Cloud: 50,
            Tags:
            ...
            { Name: "java-jetty-import", RuleType: "standard", Level: "", FileType: "(jsp$|java$)", Target: "line", Type: "regex", DefaultPattern: "^.*import(\\s*|=\")%s.*$", Advice: "Use Managed Executor", Effort: 1, Readiness: 10, Impact: "", Category: "threading", Criticality: "medium",Container: 50, Cloud: 50,
            Tags:
            ...
            { Name: "java-jks", RuleType: "standard", Level: "", FileType: "jks$", Target: "file", Type: "regex", DefaultPattern: "", Advice: "Make sure to externalize jks store", Effort: 7, Readiness: 7, Impact: "", Category: "security", Criticality: "medium",Container: 50, Cloud: 50,
            Tags:
            ...
            { Name: "java-jms", RuleType: "standard", Level: "", FileType: "java$", Target: "line", Type: "regex", DefaultPattern: "^.*[ .]%s[ ({.].*", Advice: "Run embedded service broker as a JMS Provider.", Effort: 10, Readiness: 6, Impact: "", Category: "jms", Criticality: "medium",Container: 50, Cloud: 50,
            Tags:
            ...
            { Name: "java-jndi", RuleType: "standard", Level: "", FileType: "java$", Target: "line", Type: "regex", DefaultPattern: "^.*[ .]%s[ (].*", Advice: "Refactor jndi calls", Effort: 250, Readiness: 7, Impact: "", Category: "jndi", Criticality: "medium",Container: 50, Cloud: 50,
            Tags:
            ...
            { Name: "java-jni", RuleType: "standard", Level: "", FileType: "java$", Target: "line", Type: "regex", DefaultPattern: "^\\s*%s\\s*native\\s*", Advice: "A few conditions have to be met to make JNI calls", Effort: 1000, Readiness: 7, Impact: "", Category: "jni", Criticality: "medium",Container: 50, Cloud: 50,
            Tags:
            ...
            { Name: "java-jpa", RuleType: "standard", Level: "", FileType: "java$", Target: "line", Type: "regex", DefaultPattern: "^.*[ @.]%s[ (].*", Advice: "JPA will work inside of Cloud Native applications, make sure to use best practices to externalize connection parameters.", Effort: 2, Readiness: 6, Impact: "", Category: "jpa", Criticality: "medium",Container: 50, Cloud: 50,
            Tags:
            ...
            { Name: "java-jsf", RuleType: "standard", Level: "", FileType: "java$", Target: "line", Type: "regex", DefaultPattern: "^.*[ .]%s[ (].*$", Advice: "Consider migrating to modern frameworks that have better support for the cloud.", Effort: 5, Readiness: 4, Impact: "", Category: "jsf", Criticality: "medium",Container: 50, Cloud: 50,
            Tags:
            ...
            { Name: "java-jsp", RuleType: "standard", Level: "", FileType: "java$", Target: "line", Type: "regex", DefaultPattern: "^.*[ .]%s[ (].*", Advice: "Consider migrating to modern UI frameworks that have better support for the cloud.", Effort: 2, Readiness: 5, Impact: "", Category: "jsp", Criticality: "medium",Container: 50, Cloud: 50,
            Tags:
            ...
            { Name: "java-jta", RuleType: "standard", Level: "", FileType: "java$", Target: "line", Type: "regex", DefaultPattern: "^.*[ .]%s[ (.{].*", Advice: "Distributed transactions are problematic and should be remediated.  Consider Eventual Consistency pattern.", Effort: 500, Readiness: 6, Impact: "file", Category: "jta", Criticality: "medium",Container: 50, Cloud: 50,
            Tags:
            ...
            { Name: "java-jvm-runtimeConfigProps", RuleType: "standard", Level: "", FileType: "java$", Target: "line", Type: "regex", DefaultPattern: "^.*import(\\s*|=\")%s.*$", Advice: "Do not change these properties at runtime in application code", Effort: 50, Readiness: 0, Impact: "", Category: "config", Criticality: "medium",Container: 50, Cloud: 50,
            Tags:
            []Tag{  { Value: "config",}, },
            Profiles:
            []Profile{  { Value: "cloud-suitability",}, },
            ...
            { Name: "java-logging-file-appender", RuleType: "standard", Level: "", FileType: "xml$|properties$", Target: "line", Type: "regex", DefaultPattern: "(%s)", Advice: "Replace file appender with console appender", Effort: 3, Readiness: 5, Impact: "", Category: "logging", Criticality: "medium",Container: 50, Cloud: 50,
            Tags:
            ...
            { Name: "java-logging-import", RuleType: "standard", Level: "", FileType: "(jsp$|java$)", Target: "line", Type: "regex", DefaultPattern: "^.*import(\\s*|=\")%s.*$", Advice: "Change to an implementation of SLF4J i.e. Logback", Effort: 3, Readiness: 5, Impact: "", Category: "logging", Criticality: "medium",Container: 50, Cloud: 50,
            Tags:
            []Tag{  { Value: "logging",}, },
            Profiles:
            []Profile{  { Value: "cloud-suitability",}, },
            ...
            { Name: "java-message-driven-annotations", RuleType: "standard", Level: "", FileType: "(jsp$|java$)", Target: "line", Type: "regex", DefaultPattern: "^\\s*@%s", Advice: "To convert a message driven bean to spring cloud stream with rabbitmq", Effort: 10, Readiness: 0, Impact: "", Category: "annotations", Criticality: "medium",Container: 50, Cloud: 50,
            Tags:
            ...
            { Name: "java-messageDrivenBeans", RuleType: "standard", Level: "", FileType: "java$", Target: "line", Type: "regex", DefaultPattern: "^.*@%s.*$", Advice: "Refer to platform documentation", Effort: 7, Readiness: 10, Impact: "", Category: "mdb", Criticality: "medium",Container: 50, Cloud: 50,
            Tags:
            []Tag{  { Value: "annotations",}, { Value: "mdb",}, },
            Profiles:
            []Profile{  { Value: "cloud-suitability",}, },
            ...
            { Name: "java-metrics", RuleType: "standard", Level: "", FileType: "(jsp$|java$)", Target: "line", Type: "regex", DefaultPattern: "^.*import(\\s*|=\")%s.*$", Advice: "Indicates use of a metrics collection library, which supports containerization", Effort: -10, Readiness: 7, Impact: "", Category: "metrics", Criticality: "medium",Container: 50, Cloud: 50,
            Tags:
            []Tag{  { Value: "metrics",}, },
            Profiles:
            []Profile{  { Value: "cloud-suitability",}, },
            ...
            { Name: "java-mongo-cassandra", RuleType: "standard", Level: "", FileType: "java$", Target: "line", Type: "regex", DefaultPattern: "(import)\\s+(%s)", Advice: "Application is using a non relational database", Effort: 0, Readiness: 0, Impact: "", Category: "springFramework", Criticality: "medium",Container: 50, Cloud: 50,
            Tags:
            []Tag{  { Value: "spring",}, },
            Profiles:
            []Profile{  { Value: "cloud-suitability",}, },
            ...
            { Name: "java-mqseries", RuleType: "standard", Level: "", FileType: "java$", Target: "line", Type: "regex", DefaultPattern: "^.*[ .]%s[ (].*", Advice: "You need to make sure that you are using the dependencies that match the version of IBM MQ on the server", Effort: 7, Readiness: 7, Impact: "", Category: "ibm-mq", Criticality: "medium",Container: 50, Cloud: 50,
            Tags:
            ...
            { Name: "java-mulesoft-import", RuleType: "standard", Level: "", FileType: "(jsp$|java$)", Target: "line", Type: "regex", DefaultPattern: "^.*import(\\s*|=\")%s.*$", Advice: "There are several changes required to move a Mule Project to PCF", Effort: 100, Readiness: 10, Impact: "", Category: "etl", Criticality: "medium",Container: 50, Cloud: 50,
            Tags:
            ...
            { Name: "java-mulesoft-intf", RuleType: "standard", Level: "", FileType: "java$", Target: "line", Type: "regex", DefaultPattern: "^.*[ .]%s[ {].*", Advice: "Refer to platform documentation", Effort: 10, Readiness: 10, Impact: "", Category: "etl", Criticality: "medium",Container: 50, Cloud: 50,
            Tags:
            []Tag{  { Value: "mulesoft",}, },
            Profiles:
            []Profile{  { Value: "cloud-suitability",}, },
            ...
            { Name: "java-netflix-healthcheck", RuleType: "standard", Level: "", FileType: "(jsp$|java$)", Target: "line", Type: "regex", DefaultPattern: "^.*import(\\s*|=\")%s.*$", Advice: "Indicates existance of healthcheck endpoint, which is positive finding", Effort: -100, Readiness: 7, Impact: "", Category: "health-check", Criticality: "medium",Container: 50, Cloud: 50,
            Tags:
            ...
            { Name: "java-nio", RuleType: "standard", Level: "", FileType: "java$", Target: "line", Type: "regex", DefaultPattern: "^.*[ .]%s[ (].*", Advice: "Make sure to use Cloud Friendly storage provider.", Effort: 8, Readiness: 8, Impact: "", Category: "nio", Criticality: "medium",Container: 50, Cloud: 50,
            Tags:
            []Tag{  { Value: "nio",}, },
            Profiles:
            []Profile{  { Value: "cloud-suitability",}, },
            ...
            { Name: "java-nonstandard-protocol", RuleType: "standard", Level: "", FileType: "java$", Target: "line", Type: "regex", DefaultPattern: "(%s)", Advice: "Ensure cloud friendly communication protocols", Effort: 50, Readiness: 10, Impact: "", Category: "protocol", Criticality: "medium",Container: 50, Cloud: 50,
            Tags:
            ...
            { Name: "java-persistence", RuleType: "standard", Level: "", FileType: "java$", Target: "line", Type: "regex", DefaultPattern: "^.*import(\\s*|=\")%s.*$", Advice: "Consult 3rd party documentation", Effort: 5, Readiness: 5, Impact: "", Category: "persistence", Criticality: "medium",Container: 50, Cloud: 50,
            Tags:
            ...
            { Name: "java-portUsage", RuleType: "standard", Level: "", FileType: "java$", Target: "line", Type: "regex", DefaultPattern: "^*.(%s?:.*):(\\d*)\\/?(.*)", Advice: "Ensure port usage is cloud-friendly or use TKG", Effort: 5, Readiness: 6, Impact: "", Category: "port-usage", Criticality: "medium",Container: 50, Cloud: 50,
            Tags:
            ...
            { Name: "java-rabbitmq-import", RuleType: "standard", Level: "", FileType: "(jsp$|java$)", Target: "line", Type: "regex", DefaultPattern: "^.*import(\\s*|=\")%s.*$", Advice: "Make sure that configuration is Cloud friendly", Effort: 1, Readiness: 5, Impact: "", Category: "mq", Criticality: "medium",Container: 50, Cloud: 50,
            Tags:
            ...
            { Name: "java-remoteEJB", RuleType: "standard", Level: "", FileType: "java$", Target: "line", Type: "regex", DefaultPattern: "^\\s*@%s", Advice: "Consider rearchitecting the application to use Cloud friendly remote communications - http or messaging", Effort: 10, Readiness: 10, Impact: "", Category: "ejb", Criticality: "medium",Container: 50, Cloud: 50,
            Tags:
            ...
            { Name: "java-resource-cci", RuleType: "standard", Level: "", FileType: "java$", Target: "line", Type: "regex", DefaultPattern: "^.*[ .]%s[ (].*", Advice: "Consider rearchitecting the application to use Cloud friendly remote communications - http or messaging", Effort: 70, Readiness: 7, Impact: "", Category: "jca", Criticality: "medium",Container: 50, Cloud: 50,
            Tags:
            ...
            { Name: "java-resource-spi", RuleType: "standard", Level: "", FileType: "java$", Target: "line", Type: "regex", DefaultPattern: "^.*[ .]%s[ (].*", Advice: "Consider rearchitecting the application to use Cloud friendly remote communications - http or messaging", Effort: 10, Readiness: 70, Impact: "", Category: "jca", Criticality: "medium",Container: 50, Cloud: 50,
            Tags:
            ...
            { Name: "java-rpc-import", RuleType: "standard", Level: "", FileType: "(jsp$|java$)", Target: "line", Type: "regex", DefaultPattern: "^.*import(\\s*|=\")%s.*$", Advice: "Adapt cloud friendly protocol", Effort: 2, Readiness: 10, Impact: "", Category: "web-service", Criticality: "medium",Container: 50, Cloud: 50,
            Tags:
            ...
            { Name: "java-security-annotations", RuleType: "standard", Level: "", FileType: "(jsp$|java$)", Target: "line", Type: "regex", DefaultPattern: "^\\s*@%s", Advice: "Java EE security appears to be used", Effort: 5, Readiness: 0, Impact: "", Category: "security", Criticality: "medium",Container: 50, Cloud: 50,
            Tags:
            []Tag{  { Value: "security",}, },
            Profiles:
            []Profile{  { Value: "cloud-suitability",}, },
            ...
            { Name: "java-security", RuleType: "standard", Level: "", FileType: "java$", Target: "line", Type: "regex", DefaultPattern: "^.*import(\\s*|=\")%s.*$", Advice: "Application is using a java keystore", Effort: 10, Readiness: 0, Impact: "", Category: "security", Criticality: "medium",Container: 50, Cloud: 50,
            Tags:
            []Tag{  { Value: "security",}, },
            Profiles:
            []Profile{  { Value: "cloud-suitability",}, },
            ...
            { Name: "java-servlet-session", RuleType: "standard", Level: "", FileType: "java$", Target: "line", Type: "regex", DefaultPattern: "^.*import(\\s*|=\")%s.*$", Advice: "HTTP Session Java API Import. Make sure that externalized data store is used for session", Effort: 10, Readiness: 0, Impact: "", Category: "servlet", Criticality: "medium",Container: 50, Cloud: 50,
            Tags:
            ...
            { Name: "java-servlet", RuleType: "standard", Level: "", FileType: "java$", Target: "line", Type: "regex", DefaultPattern: "^.*import(\\s*|=\")%s.*$", Advice: "Servlet Java API Import", Effort: 1, Readiness: 0, Impact: "", Category: "servlet", Criticality: "medium",Container: 50, Cloud: 50,
            Tags:
            ...
            { Name: "java-slf4j-import", RuleType: "standard", Level: "", FileType: "(jsp$|java$)", Target: "line", Type: "regex", DefaultPattern: "^.*import(\\s*|=\")%s.*$", Advice: "Review logging configuration and remove file appenders.", Effort: 1, Readiness: 0, Impact: "", Category: "slf4j", Criticality: "medium",Container: 50, Cloud: 50,
            Tags:
            ...
            { Name: "java-soap", RuleType: "standard", Level: "", FileType: "java$", Target: "line", Type: "regex", DefaultPattern: "^.* %s.*[(].*", Advice: "Consider upgrading to modern cloud native messaging", Effort: 4, Readiness: 3, Impact: "", Category: "soap", Criticality: "medium",Container: 50, Cloud: 50,
            Tags:
            ...
            { Name: "java-springboot-annotations", RuleType: "standard", Level: "", FileType: "java$", Target: "line", Type: "regex", DefaultPattern: "^\\s*@%s", Advice: "Spring Boot is a positive score", Effort: -100, Readiness: 0, Impact: "", Category: "spring-boot", Criticality: "medium",Container: 50, Cloud: 50,
            Tags:
            []Tag{  { Value: "spring-boot",}, },
            Profiles:
            []Profile{  { Value: "cloud-suitability",}, },
            ...
            { Name: "java-springframework", RuleType: "standard", Level: "", FileType: "java$", Target: "line", Type: "contains", DefaultPattern: "", Advice: "Presence of spring framework may indicate the app should target TAS", Effort: -100, Readiness: 0, Impact: "", Category: "springFramework", Criticality: "medium",Container: 50, Cloud: 50,
            Tags:
            []Tag{  { Value: "spring",}, },
            Profiles:
            []Profile{  { Value: "cloud-suitability",}, },
            ...
            { Name: "java-stateless-annotations", RuleType: "standard", Level: "", FileType: "(jsp$|java$)", Target: "line", Type: "regex", DefaultPattern: "^\\s*@%s", Advice: "Consider rearchitecting if decisions is made to not use application server", Effort: 5, Readiness: 0, Impact: "", Category: "stateless", Criticality: "medium",Container: 50, Cloud: 50,
            Tags:
            ...
            { Name: "java-struts-import", RuleType: "standard", Level: "", FileType: "(jsp$|java$)", Target: "line", Type: "regex", DefaultPattern: "^.*import(\\s*|=\")%s.*$", Advice: "Consider upgrading to modern cloud native UI framework", Effort: 6, Readiness: 7, Impact: "", Category: "struts", Criticality: "medium",Container: 50, Cloud: 50,
            Tags:
            ...
            { Name: "java-struts", RuleType: "standard", Level: "", FileType: "java$", Target: "line", Type: "regex", DefaultPattern: "^.*[ .]%s[ (].*", Advice: "Consider upgrading to modern cloud native UI framework", Effort: 6, Readiness: 7, Impact: "", Category: "struts", Criticality: "medium",Container: 50, Cloud: 50,
            Tags:
            []Tag{  { Value: "struts",}, { Value: "web-app",}, { Value: "web-container",}, },
            Profiles:
            []Profile{  { Value: "cloud-suitability",}, },
            ...
            { Name: "java-swing", RuleType: "standard", Level: "", FileType: "java$", Target: "line", Type: "regex", DefaultPattern: "^.*[ .]%s[ (].*", Advice: "Consider upgrading to modern cloud native UI framework", Effort: 500, Readiness: 100, Impact: "", Category: "Swing", Criticality: "medium",Container: 50, Cloud: 50,
            Tags:
            ...
            { Name: "java-system-config", RuleType: "standard", Level: "", FileType: "$", Target: "line", Type: "regex", DefaultPattern: "(System.)%s\\(", Advice: "Review usage of environment variables and system properties and externalize.", Effort: 3, Readiness: 10, Impact: "", Category: "config", Criticality: "medium",Container: 50, Cloud: 50,
            Tags:
            []Tag{  { Value: "config",}, },
            Profiles:
            []Profile{  { Value: "cloud-suitability",}, },
            ...
            { Name: "java-systemLoad", RuleType: "standard", Level: "", FileType: "java$", Target: "line", Type: "regex", DefaultPattern: "(System.)%s", Advice: "Remediate to cloud friendly implentation", Effort: 1000, Readiness: 10, Impact: "", Category: "process-launch", Criticality: "medium",Container: 50, Cloud: 50,
            Tags:
            []Tag{  { Value: "jni",}, },
            Profiles:
            []Profile{  { Value: "cloud-suitability",}, },
            ...
            { Name: "java-tangosol", RuleType: "standard", Level: "", FileType: "java$", Target: "line", Type: "regex", DefaultPattern: "^.*[ .]%s[ ({.<].*", Advice: "Convert to cloud friendly cache implementation", Effort: 10, Readiness: 6, Impact: "", Category: "cache", Criticality: "medium",Container: 50, Cloud: 50,
            Tags:
            ...
            { Name: "java-threadUsage-import", RuleType: "standard", Level: "", FileType: "(jsp$|java$)", Target: "line", Type: "regex", DefaultPattern: "^.*import(\\s*|=\")%s.*$", Advice: "Use Managed Executor", Effort: 100, Readiness: 10, Impact: "", Category: "threading", Criticality: "medium",Container: 50, Cloud: 50,
            Tags:
            []Tag{  { Value: "threading",}, },
            Profiles:
            []Profile{  { Value: "cloud-suitability",}, },
            ...
            { Name: "java-transportSecurity", RuleType: "standard", Level: "", FileType: "java$", Target: "line", Type: "regex", DefaultPattern: "(%s)", Advice: "Servlet data protection is used, make sure that it is supported by target platform runtime", Effort: 10, Readiness: 10, Impact: "", Category: "Security", Criticality: "medium",Container: 50, Cloud: 50,
            Tags:
            ...
            { Name: "java-weblogic-import", RuleType: "standard", Level: "", FileType: "java$", Target: "line", Type: "regex", DefaultPattern: "^import\\s*%s.*", Advice: "Consider rearchitecting if decision is made to move off application server", Effort: 100, Readiness: 10, Impact: "", Category: "oracle", Criticality: "medium",Container: 50, Cloud: 50,
            Tags:
            []Tag{  { Value: "weblogic",}, },
            Profiles:
            []Profile{  { Value: "cloud-suitability",}, },
            ...
            { Name: "java-weblogic", RuleType: "standard", Level: "", FileType: "java$", Target: "line", Type: "regex", DefaultPattern: "^.*import(\\s*|=\")%s.*$", Advice: "Consider rearchitecting if decision is made to move off application server", Effort: 50, Readiness: 10, Impact: "", Category: "webLogic", Criticality: "medium",Container: 50, Cloud: 50,
            Tags:
            []Tag{  { Value: "weblogic",}, },
            Profiles:
            []Profile{  { Value: "cloud-suitability",}, },
            ...
            { Name: "java-websockets-import", RuleType: "standard", Level: "", FileType: "java$", Target: "line", Type: "regex", DefaultPattern: "^import\\s*%s.*", Advice: "Make sure that target platform supports websocket api", Effort: 100, Readiness: 100, Impact: "", Category: "websockets", Criticality: "medium",Container: 50, Cloud: 50,
            Tags:
            ...
            { Name: "java-ws2liberty-import", RuleType: "standard", Level: "", FileType: "(jsp$|java$)", Target: "line", Type: "regex", DefaultPattern: "^.*import(\\s*|=\")%s.*$", Advice: "Vendor proprietary implementation.  Consider rearchitecting if decision is made to move off application server", Effort: 10, Readiness: 10, Impact: "", Category: "webSphere", Criticality: "medium",Container: 50, Cloud: 50,
            Tags:
            []Tag{  { Value: "liberty",}, },
            Profiles:
            []Profile{  { Value: "cloud-suitability",}, },
            ...
            { Name: "java-ws2liberty-methods", RuleType: "standard", Level: "", FileType: "java$", Target: "line", Type: "regex", DefaultPattern: "^.*[ .]%s[ (].*", Advice: "Vendor proprietary implementation.  Consider rearchitecting if decision is made to move off application server", Effort: 10, Readiness: 10, Impact: "", Category: "webSphere", Criticality: "medium",Container: 50, Cloud: 50,
            Tags:
            ...
            { Name: "js-bool-comparison", RuleType: "standard", Level: "", FileType: "js$", Target: "line", Type: "regex", DefaultPattern: "(!|=)=\\\\s+%s", Advice: "Boolean literals should be avoided in comparison expressions == and != to improve code readability.", Effort: 1, Readiness: 10, Impact: "", Category: "design", Criticality: "medium",Container: 50, Cloud: 50,
            Tags:
            ...
            { Name: "js-continue", RuleType: "standard", Level: "", FileType: "js$", Target: "line", Type: "regex", DefaultPattern: "(\\\\s+)?%s(\\\\s+)?;", Advice: "continue is an unstructured control flow statement. It makes code less testable, less readable and less maintainable. Structured control flow statements such as if should be used instead.", Effort: 1, Readiness: 10, Impact: "", Category: "design", Criticality: "medium",Container: 50, Cloud: 50,
            Tags:
            ...
            { Name: "js-md5-sha1-noncompliant", RuleType: "standard", Level: "", FileType: "js$", Target: "line", Type: "regex", DefaultPattern: ".*(%s)\\s*(1.1)+", Advice: "TLS1.1 is not secure", Effort: 5, Readiness: 1000, Impact: "", Category: "security", Criticality: "medium",Container: 50, Cloud: 50,
            Tags:
            []Tag{  { Value: "vulnerability",}, },
            Profiles:
            []Profile{  { Value: "cloud-suitability",}, },
            ...
            { Name: "js-var", RuleType: "standard", Level: "", FileType: "js$", Target: "line", Type: "regex", DefaultPattern: "(\\\\s+)?%s\\\\s+", Advice: "ECMAScript 2015 introduced the let and const keywords for block-scope variable declaration. Using const creates a read-only (constant) variable.", Effort: 1, Readiness: 10, Impact: "", Category: "design", Criticality: "medium",Container: 50, Cloud: 50,
            Tags:
            []Tag{  { Value: "read-only",}, },
            Profiles:
            []Profile{  { Value: "cloud-suitability",}, },
            ...
            { Name: "log2file-import", RuleType: "standard", Level: "", FileType: "(jsp$|java$)", Target: "line", Type: "regex", DefaultPattern: "^.*import(\\s*|=\")%s.*$", Advice: "Logging should be to console", Effort: 1, Readiness: 8, Impact: "", Category: "log2file", Criticality: "medium",Container: 50, Cloud: 50,
            Tags:
            []Tag{  { Value: "log2file",}, },
            Profiles:
            []Profile{  { Value: "cloud-suitability",}, },
            ...
            { Name: "log4j-properties", RuleType: "standard", Level: "", FileType: "log4j2.properties$", Target: "line", Type: "regex", DefaultPattern: "(%s)", Advice: "Refer to platform documentation", Effort: 1, Readiness: 0, Impact: "", Category: "log2file", Criticality: "medium",Container: 50, Cloud: 50,
            Tags:
            []Tag{  { Value: "log2file",}, },
            Profiles:
            []Profile{  { Value: "cloud-suitability",}, },
            ...
            { Name: "log4j-xml", RuleType: "standard", Level: "", FileType: "log4j2.xml$", Target: "line", Type: "regex", DefaultPattern: "(%s)", Advice: "Refer to platform documentation", Effort: 1, Readiness: 0, Impact: "", Category: "log2file", Criticality: "medium",Container: 50, Cloud: 50,
            Tags:
            []Tag{  { Value: "log2file",}, },
            Profiles:
            []Profile{  { Value: "cloud-suitability",}, },
            ...
            { Name: "dotnet-ISAPI-Filters-config", RuleType: "standard", Level: "", FileType: "config$", Target: "file", Type: "xpath", DefaultPattern: "", Advice: "Windows and IIS server dependency. Not supported in .netCore targeting linux.", Effort: 1000, Readiness: 10, Impact: "", Category: "unsupported-iis-module", Criticality: "medium",Container: 50, Cloud: 50,
            Tags:
            ...
            { Name: "dotnet-ISAPI-Filters-vbcs", RuleType: "standard", Level: "", FileType: "(cs$|vb$)", Target: "line", Type: "regex", DefaultPattern: ".*%s.*", Advice: "Windows and IIS server dependency. Not supported in .netCore targeting linux.", Effort: 1000, Readiness: 0, Impact: "", Category: "unsupported-iis-module", Criticality: "medium",Container: 50, Cloud: 50,
            Tags:
            ...
            { Name: "dotnet-ip-address", RuleType: "standard", Level: "", FileType: "(cs$|vb$)", Target: "line", Type: "regex", DefaultPattern: ".*%s.*", Advice: "Not supported in .netCore, Use IHttpContextAccessor instead", Effort: 10, Readiness: 9, Impact: "", Category: "unsupported-netcore", Criticality: "medium",Container: 50, Cloud: 50,
            Tags:
            []Tag{  { Value: "debt",}, },
            Profiles:
            []Profile{  { Value: "netcore",}, },
            ...
            { Name: "dotnet-asp-classic-2-0", RuleType: "standard", Level: "", FileType: "(asp$)", Target: "line", Type: "regex", DefaultPattern: "\\s%s.*", Advice: "Not supported by many PAS. ASP .net pages will have to be replaced by ASP .NetCore", Effort: 10, Readiness: 9, Impact: "", Category: "Unsupported", Criticality: "medium",Container: 50, Cloud: 50,
            Tags:
            ...
            { Name: "dotnet-asp-machine-key", RuleType: "standard", Level: "", FileType: "config$", Target: "file", Type: "xpath", DefaultPattern: "", Advice: "Not supported in .NetCore. Will have to be replaced https://learn.microsoft.com/en-us/aspnet/core/security/data-protection/compatibility/replacing-machinekey?view=aspnetcore-7.0", Effort: 10, Readiness: 9, Impact: "", Category: "unsupported-netcore", Criticality: "medium",Container: 50, Cloud: 50,
            Tags:
            ...
            { Name: "dotnet-asp-membership", RuleType: "standard", Level: "", FileType: "config$", Target: "file", Type: "xpath", DefaultPattern: "", Advice: "Not supported, replaced by ASP.NET Core Identity. Manage users in Database.", Effort: 10, Readiness: 9, Impact: "", Category: "unsupported-netcore", Criticality: "medium",Container: 50, Cloud: 50,
            Tags:
            ...
            { Name: "dotnet-asp-mvc-form-collection", RuleType: "standard", Level: "", FileType: "(cs$|vb$)", Target: "line", Type: "regex", DefaultPattern: "%s", Advice: "Not supported, Replace with IFormCollection", Effort: 10, Readiness: 9, Impact: "", Category: "unsupported-netcore", Criticality: "medium",Container: 50, Cloud: 50,
            Tags:
            ...
            { Name: "dotnet-asp-mvc-model-update", RuleType: "standard", Level: "", FileType: "(cs$|vb$)", Target: "line", Type: "regex", DefaultPattern: ".*\\s%s<.*", Advice: "Not supported in .NetCore, Replace with TryUpdateModelAsync", Effort: 10, Readiness: 9, Impact: "", Category: "unsupported-netcore", Criticality: "medium",Container: 50, Cloud: 50,
            Tags:
            []Tag{  { Value: "mvc",}, { Value: "asp",}, { Value: "unsupported-netcore",}, },
            Profiles:
            []Profile{  { Value: "netcore",}, },
            ...
            { Name: "dotnet-asp-mvc", RuleType: "standard", Level: "", FileType: "(cs$|vb$)", Target: "line", Type: "regex", DefaultPattern: ".*%s.*", Advice: "Not supported on .netCore. Migrate to ASP .NetCore and replace with Microsoft.AspNetCore.Mvc", Effort: 10, Readiness: 9, Impact: "", Category: "unsupported-netcore", Criticality: "medium",Container: 50, Cloud: 50,
            Tags:
            []Tag{  { Value: "mvc",}, { Value: "asp",}, { Value: "unsupported-netcore",}, },
            Profiles:
            []Profile{  { Value: "netcore",}, },
            ...
            { Name: "dotnet-asp-session-context", RuleType: "standard", Level: "", FileType: "(cs$|vb$)", Target: "line", Type: "regex", DefaultPattern: ".*%s.*", Advice: "Not supported, Replace with IHttpContextAccessor to manage session data", Effort: 10, Readiness: 9, Impact: "", Category: "unsupported-netcore", Criticality: "medium",Container: 50, Cloud: 50,
            Tags:
            ...
            { Name: "dotnet-asp-web-form", RuleType: "standard", Level: "", FileType: "(aspx$)", Target: "line", Type: "regex", DefaultPattern: "(%s)", Advice: "Unsupported-netcore. Not supported by many PAS. ASP .net pages will have to be replaced by ASP .NetCore. See https://learn.microsoft.com/en-us/dotnet/architecture/porting-existing-aspnet-apps/migrate-web-forms", Effort: 10, Readiness: 9, Impact: "", Category: "unsupported-netcore.", Criticality: "medium",Container: 50, Cloud: 50,
            Tags:
            ...
            { Name: "dotnet-classic-asp-net", RuleType: "standard", Level: "", FileType: "(cs$)", Target: "line", Type: "regex", DefaultPattern: ".*%s.*", Advice: "Unsupported-netcore. Not supported by many PAS. ASP .net pages will have to be replaced by ASP .NetCore. See https://learn.microsoft.com/en-us/dotnet/architecture/porting-existing-aspnet-apps/migrate-web-forms", Effort: 10, Readiness: 10, Impact: "", Category: "API", Criticality: "medium",Container: 50, Cloud: 50,
            Tags:
            []Tag{  { Value: "asp-classic",}, { Value: "unsupported-netcore",}, },
            Profiles:
            []Profile{  { Value: "netcore",}, },
            ...
            { Name: "dotnet-identity-foundation", RuleType: "standard", Level: "", FileType: "(cs$)", Target: "line", Type: "regex", DefaultPattern: ".*%s.*", Advice: "Windows Identity Foundation (WIF) won't be ported to .NET Core. See https://aka.ms/unsupported-netfx-api.", Effort: 10, Readiness: 10, Impact: "", Category: "WIF", Criticality: "medium",Container: 50, Cloud: 50,
            Tags:
            ...
            { Name: "dotnet-iis_module-Authorization", RuleType: "standard", Level: "", FileType: "config$", Target: "file", Type: "xpath", DefaultPattern: "", Advice: "Windows and IIS server dependency. Not supported in .netCore targeting linux.", Effort: 10, Readiness: 9, Impact: "", Category: "unsupported-iis-module", Criticality: "medium",Container: 50, Cloud: 50,
            Tags:
            []Tag{  { Value: "iis-module",}, },
            Profiles:
            []Profile{  { Value: "netcore",}, },
            ...
            { Name: "dotnet-iis_module-DefaultDocument", RuleType: "standard", Level: "", FileType: "config$", Target: "file", Type: "xpath", DefaultPattern: "", Advice: "Windows and IIS server dependency. Not supported in .netCore targeting linux.", Effort: 10, Readiness: 9, Impact: "", Category: "unsupported-iis-module", Criticality: "medium",Container: 50, Cloud: 50,
            Tags:
            []Tag{  { Value: "iis-module",}, },
            Profiles:
            []Profile{  { Value: "netcore",}, },
            ...
            { Name: "dotnet-iis_module-HttpErrors", RuleType: "standard", Level: "", FileType: "config$", Target: "file", Type: "xpath", DefaultPattern: "", Advice: "Windows and IIS server dependency. Not supported in .netCore targeting linux.", Effort: 10, Readiness: 9, Impact: "", Category: "unsupported-iis-module", Criticality: "medium",Container: 50, Cloud: 50,
            Tags:
            []Tag{  { Value: "iis-module",}, },
            Profiles:
            []Profile{  { Value: "netcore",}, },
            ...
            { Name: "dotnet-iis_module-HttpLogging", RuleType: "standard", Level: "", FileType: "config$", Target: "file", Type: "xpath", DefaultPattern: "", Advice: "Windows and IIS server dependency. Not supported in .netCore targeting linux.", Effort: 10, Readiness: 9, Impact: "", Category: "unsupported-iis-module", Criticality: "medium",Container: 50, Cloud: 50,
            Tags:
            []Tag{  { Value: "iis-module",}, },
            Profiles:
            []Profile{  { Value: "netcore",}, },
            ...
            { Name: "dotnet-iis_module-HttpRedirection", RuleType: "standard", Level: "", FileType: "config$", Target: "file", Type: "xpath", DefaultPattern: "", Advice: "Windows and IIS server dependency. Not supported in .netCore targeting linux.", Effort: 10, Readiness: 9, Impact: "", Category: "unsupported-iis-module", Criticality: "medium",Container: 50, Cloud: 50,
            Tags:
            []Tag{  { Value: "iis-module",}, },
            Profiles:
            []Profile{  { Value: "netcore",}, },
            ...
            { Name: "dotnet-iis_module-IpSecurity", RuleType: "standard", Level: "", FileType: "config$", Target: "file", Type: "xpath", DefaultPattern: "", Advice: "Windows and IIS server dependency. Not supported in .netCore targeting linux.", Effort: 10, Readiness: 9, Impact: "", Category: "unsupported-iis-module", Criticality: "medium",Container: 50, Cloud: 50,
            Tags:
            []Tag{  { Value: "iis-module",}, },
            Profiles:
            []Profile{  { Value: "netcore",}, },
            ...
            { Name: "dotnet-iis_module-OutputCache", RuleType: "standard", Level: "", FileType: "config$", Target: "file", Type: "xpath", DefaultPattern: "", Advice: "Windows and IIS server dependency. Not supported in .netCore targeting linux.", Effort: 10, Readiness: 9, Impact: "", Category: "unsupported-iis-module", Criticality: "medium",Container: 50, Cloud: 50,
            Tags:
            []Tag{  { Value: "iis-module",}, },
            Profiles:
            []Profile{  { Value: "netcore",}, },
            ...
            { Name: "dotnet-iis_module-ProtocolSupport", RuleType: "standard", Level: "", FileType: "config$", Target: "file", Type: "xpath", DefaultPattern: "", Advice: "Windows and IIS server dependency. Not supported in .netCore targeting linux.", Effort: 10, Readiness: 9, Impact: "", Category: "unsupported-iis-module", Criticality: "medium",Container: 50, Cloud: 50,
            Tags:
            []Tag{  { Value: "iis-module",}, },
            Profiles:
            []Profile{  { Value: "netcore",}, },
            ...
            { Name: "dotnet-iis_module-Tracing", RuleType: "standard", Level: "", FileType: "config$", Target: "file", Type: "xpath", DefaultPattern: "", Advice: "Windows and IIS server dependency. Not supported in .netCore targeting linux.", Effort: 10, Readiness: 9, Impact: "", Category: "unsupported-iis-module", Criticality: "medium",Container: 50, Cloud: 50,
            Tags:
            []Tag{  { Value: "iis-module",}, },
            Profiles:
            []Profile{  { Value: "netcore",}, },
            ...
            { Name: "dotnet-iis_module-Validation", RuleType: "standard", Level: "", FileType: "config$", Target: "file", Type: "xpath", DefaultPattern: "", Advice: "Windows and IIS server dependency. Not supported in .netCore targeting linux.", Effort: 10, Readiness: 9, Impact: "", Category: "unsupported-iis-module", Criticality: "medium",Container: 50, Cloud: 50,
            Tags:
            []Tag{  { Value: "iis-module",}, },
            Profiles:
            []Profile{  { Value: "netcore",}, },
            ...
            { Name: "dotnet-javascript-serializer", RuleType: "standard", Level: "", FileType: "(cs$)", Target: "line", Type: "regex", DefaultPattern: ".*%s.*", Advice: "Use JSON.NET instead.", Effort: 10, Readiness: 10, Impact: "", Category: "API", Criticality: "medium",Container: 50, Cloud: 50,
            Tags:
            []Tag{  { Value: "api",}, { Value: "unsupported-netcore",}, },
            Profiles:
            []Profile{  { Value: "netcore",}, },
            ...
            { Name: "dotnet-managed-addin", RuleType: "standard", Level: "", FileType: "(cs$)", Target: "line", Type: "regex", DefaultPattern: ".*%s.*", Advice: "Managed Addin Framework (MAF) won't be ported to .NET Core. See https://aka.ms/unsupported-netfx-api.", Effort: 10, Readiness: 10, Impact: "", Category: "API", Criticality: "medium",Container: 50, Cloud: 50,
            Tags:
            []Tag{  { Value: "api",}, { Value: "unsupported-netcore",}, },
            Profiles:
            []Profile{  { Value: "netcore",}, },
            ...
            { Name: "dotnet-package-app-metrics-extensions-hosting", RuleType: "standard", Level: "", FileType: "(config$)", Target: "line", Type: "regex", DefaultPattern: ".*%s.*", Advice: "Not Supported in .NetCore", Effort: 10, Readiness: 10, Impact: "", Category: "package", Criticality: "medium",Container: 50, Cloud: 50,
            Tags:
            ...
            { Name: "dotnet-package-autofac-mvc5", RuleType: "standard", Level: "", FileType: "(config$)", Target: "line", Type: "regex", DefaultPattern: ".*%s.*", Advice: "Not Supported in .NetCore", Effort: 10, Readiness: 10, Impact: "", Category: "package", Criticality: "medium",Container: 50, Cloud: 50,
            Tags:
            []Tag{  { Value: "unsupported-netcore",}, },
            Profiles:
            []Profile{  { Value: "netcore",}, },
            ...
            { Name: "dotnet-package-autofac-owin", RuleType: "standard", Level: "", FileType: "(config$)", Target: "line", Type: "regex", DefaultPattern: ".*%s.*", Advice: "Not Supported in .NetCore", Effort: 10, Readiness: 10, Impact: "", Category: "package", Criticality: "medium",Container: 50, Cloud: 50,
            Tags:
            []Tag{  { Value: "unsupported-netcore",}, },
            Profiles:
            []Profile{  { Value: "netcore",}, },
            ...
            { Name: "dotnet-package-autofac-webapi2-owin", RuleType: "standard", Level: "", FileType: "(config$)", Target: "line", Type: "regex", DefaultPattern: ".*%s.*", Advice: "Not Supported in .NetCore", Effort: 10, Readiness: 10, Impact: "", Category: "package", Criticality: "medium",Container: 50, Cloud: 50,
            Tags:
            []Tag{  { Value: "unsupported-netcore",}, },
            Profiles:
            []Profile{  { Value: "netcore",}, },
            ...
            { Name: "dotnet-package-autofac-webapi2", RuleType: "standard", Level: "", FileType: "(config$)", Target: "line", Type: "regex", DefaultPattern: ".*%s.*", Advice: "Not Supported in .NetCore", Effort: 10, Readiness: 10, Impact: "", Category: "package", Criticality: "medium",Container: 50, Cloud: 50,
            Tags:
            []Tag{  { Value: "unsupported-netcore",}, },
            Profiles:
            []Profile{  { Value: "netcore",}, },
            ...
            { Name: "dotnet-package-dotnetopenauth-core", RuleType: "standard", Level: "", FileType: "(config$)", Target: "line", Type: "regex", DefaultPattern: ".*%s.*", Advice: "Not Supported in .NetCore", Effort: 10, Readiness: 10, Impact: "", Category: "package", Criticality: "medium",Container: 50, Cloud: 50,
            Tags:
            []Tag{  { Value: "unsupported-netcore",}, },
            Profiles:
            []Profile{  { Value: "netcore",}, },
            ...
            { Name: "dotnet-package-fluentvalidation-mvc5", RuleType: "standard", Level: "", FileType: "(config$)", Target: "line", Type: "regex", DefaultPattern: ".*%s.*", Advice: "Not Supported in .NetCore", Effort: 10, Readiness: 10, Impact: "", Category: "package", Criticality: "medium",Container: 50, Cloud: 50,
            Tags:
            []Tag{  { Value: "unsupported-netcore",}, },
            Profiles:
            []Profile{  { Value: "netcore",}, },
            ...
            { Name: "dotnet-package-fluentvalidation-webapi", RuleType: "standard", Level: "", FileType: "(config$)", Target: "line", Type: "regex", DefaultPattern: ".*%s.*", Advice: "Not Supported in .NetCore", Effort: 10, Readiness: 10, Impact: "", Category: "package", Criticality: "medium",Container: 50, Cloud: 50,
            Tags:
            []Tag{  { Value: "unsupported-netcore",}, },
            Profiles:
            []Profile{  { Value: "netcore",}, },
            ...
            { Name: "dotnet-package-glimpse", RuleType: "standard", Level: "", FileType: "(config$)", Target: "line", Type: "regex", DefaultPattern: ".*%s.*", Advice: "Not Supported in .NetCore", Effort: 10, Readiness: 10, Impact: "", Category: "package", Criticality: "medium",Container: 50, Cloud: 50,
            Tags:
            []Tag{  { Value: "unsupported-netcore",}, },
            Profiles:
            []Profile{  { Value: "netcore",}, },
            ...
            { Name: "dotnet-package-imageprocessor-web", RuleType: "standard", Level: "", FileType: "(config$)", Target: "line", Type: "regex", DefaultPattern: ".*%s.*", Advice: "Not Supported in .NetCore", Effort: 10, Readiness: 10, Impact: "", Category: "package", Criticality: "medium",Container: 50, Cloud: 50,
            Tags:
            []Tag{  { Value: "unsupported-netcore",}, },
            Profiles:
            []Profile{  { Value: "netcore",}, },
            ...
            { Name: "dotnet-package-imageprocessor", RuleType: "standard", Level: "", FileType: "(config$)", Target: "line", Type: "regex", DefaultPattern: ".*%s.*", Advice: "Not Supported in .NetCore", Effort: 10, Readiness: 10, Impact: "", Category: "package", Criticality: "medium",Container: 50, Cloud: 50,
            Tags:
            []Tag{  { Value: "unsupported-netcore",}, },
            Profiles:
            []Profile{  { Value: "netcore",}, },
            ...
            { Name: "dotnet-package-imageresizer", RuleType: "standard", Level: "", FileType: "(config$)", Target: "line", Type: "regex", DefaultPattern: ".*%s.*", Advice: "Not Supported in .NetCore", Effort: 10, Readiness: 10, Impact: "", Category: "package", Criticality: "medium",Container: 50, Cloud: 50,
            Tags:
            []Tag{  { Value: "unsupported-netcore",}, },
            Profiles:
            []Profile{  { Value: "netcore",}, },
            ...
            { Name: "dotnet-package-microsoft-aspnet-friendlyurls-core", RuleType: "standard", Level: "", FileType: "(config$)", Target: "line", Type: "regex", DefaultPattern: ".*%s.*", Advice: "Not Supported in .NetCore", Effort: 10, Readiness: 10, Impact: "", Category: "package", Criticality: "medium",Container: 50, Cloud: 50,
            Tags:
            []Tag{  { Value: "unsupported-netcore",}, },
            Profiles:
            []Profile{  { Value: "netcore",}, },
            ...
            { Name: "dotnet-package-microsoft-aspnet-identity-entityframework", RuleType: "standard", Level: "", FileType: "(config$)", Target: "line", Type: "regex", DefaultPattern: ".*%s.*", Advice: "Not Supported in .NetCore", Effort: 10, Readiness: 10, Impact: "", Category: "package", Criticality: "medium",Container: 50, Cloud: 50,
            Tags:
            []Tag{  { Value: "unsupported-netcore",}, },
            Profiles:
            []Profile{  { Value: "netcore",}, },
            ...
            { Name: "dotnet-package-microsoft-aspnet-mvc", RuleType: "standard", Level: "", FileType: "(config$)", Target: "line", Type: "regex", DefaultPattern: ".*%s.*", Advice: "Not Supported in .NetCore", Effort: 10, Readiness: 10, Impact: "", Category: "package", Criticality: "medium",Container: 50, Cloud: 50,
            Tags:
            []Tag{  { Value: "unsupported-netcore",}, },
            Profiles:
            []Profile{  { Value: "netcore",}, },
            ...
            { Name: "dotnet-package-microsoft-aspnet-signalr", RuleType: "standard", Level: "", FileType: "(config$)", Target: "line", Type: "regex", DefaultPattern: ".*%s.*", Advice: "Not Supported in .NetCore", Effort: 10, Readiness: 10, Impact: "", Category: "package", Criticality: "medium",Container: 50, Cloud: 50,
            Tags:
            []Tag{  { Value: "unsupported-netcore",}, },
            Profiles:
            []Profile{  { Value: "netcore",}, },
            ...
            { Name: "dotnet-package-microsoft-aspnet-webapi-versioning", RuleType: "standard", Level: "", FileType: "(config$)", Target: "line", Type: "regex", DefaultPattern: ".*%s.*", Advice: "Not Supported in .NetCore", Effort: 10, Readiness: 10, Impact: "", Category: "package", Criticality: "medium",Container: 50, Cloud: 50,
            Tags:
            []Tag{  { Value: "unsupported-netcore",}, },
            Profiles:
            []Profile{  { Value: "netcore",}, },
            ...
            { Name: "dotnet-package-microsoft-azure-common-dependencies", RuleType: "standard", Level: "", FileType: "(config$)", Target: "line", Type: "regex", DefaultPattern: ".*%s.*", Advice: "Not Supported in .NetCore", Effort: 10, Readiness: 10, Impact: "", Category: "package", Criticality: "medium",Container: 50, Cloud: 50,
            Tags:
            []Tag{  { Value: "unsupported-netcore",}, },
            Profiles:
            []Profile{  { Value: "netcore",}, },
            ...
            { Name: "dotnet-package-microsoft-build-locator", RuleType: "standard", Level: "", FileType: "(config$)", Target: "line", Type: "regex", DefaultPattern: ".*%s.*", Advice: "Not Supported in .NetCore", Effort: 10, Readiness: 10, Impact: "", Category: "package", Criticality: "medium",Container: 50, Cloud: 50,
            Tags:
            []Tag{  { Value: "unsupported-netcore",}, },
            Profiles:
            []Profile{  { Value: "netcore",}, },
            ...
            { Name: "dotnet-package-microsoft-build-tasks-git", RuleType: "standard", Level: "", FileType: "(config$)", Target: "line", Type: "regex", DefaultPattern: ".*%s.*", Advice: "Not Supported in .NetCore", Effort: 10, Readiness: 10, Impact: "", Category: "package", Criticality: "medium",Container: 50, Cloud: 50,
            Tags:
            []Tag{  { Value: "unsupported-netcore",}, },
            Profiles:
            []Profile{  { Value: "netcore",}, },
            ...
            { Name: "dotnet-package-microsoft-codeanalysis-workspaces-msbuild", RuleType: "standard", Level: "", FileType: "(config$)", Target: "line", Type: "regex", DefaultPattern: ".*%s.*", Advice: "Not Supported in .NetCore", Effort: 10, Readiness: 10, Impact: "", Category: "package", Criticality: "medium",Container: 50, Cloud: 50,
            Tags:
            []Tag{  { Value: "unsupported-netcore",}, },
            Profiles:
            []Profile{  { Value: "netcore",}, },
            ...
            { Name: "dotnet-package-microsoft-crmsdk-coreassemblies", RuleType: "standard", Level: "", FileType: "(config$)", Target: "line", Type: "regex", DefaultPattern: ".*%s.*", Advice: "Not Supported in .NetCore", Effort: 10, Readiness: 10, Impact: "", Category: "package", Criticality: "medium",Container: 50, Cloud: 50,
            Tags:
            []Tag{  { Value: "unsupported-netcore",}, },
            Profiles:
            []Profile{  { Value: "netcore",}, },
            ...
            { Name: "dotnet-package-microsoft-crmsdk-deployment", RuleType: "standard", Level: "", FileType: "(config$)", Target: "line", Type: "regex", DefaultPattern: ".*%s.*", Advice: "Not Supported in .NetCore", Effort: 10, Readiness: 10, Impact: "", Category: "package", Criticality: "medium",Container: 50, Cloud: 50,
            Tags:
            []Tag{  { Value: "unsupported-netcore",}, },
            Profiles:
            []Profile{  { Value: "netcore",}, },
            ...
            { Name: "dotnet-package-microsoft-crmsdk-workflow", RuleType: "standard", Level: "", FileType: "(config$)", Target: "line", Type: "regex", DefaultPattern: ".*%s.*", Advice: "Not Supported in .NetCore", Effort: 10, Readiness: 10, Impact: "", Category: "package", Criticality: "medium",Container: 50, Cloud: 50,
            Tags:
            []Tag{  { Value: "unsupported-netcore",}, },
            Profiles:
            []Profile{  { Value: "netcore",}, },
            ...
            { Name: "dotnet-package-microsoft-crmsdk-xrmtooling-coreassembly", RuleType: "standard", Level: "", FileType: "(config$)", Target: "line", Type: "regex", DefaultPattern: ".*%s.*", Advice: "Not Supported in .NetCore", Effort: 10, Readiness: 10, Impact: "", Category: "package", Criticality: "medium",Container: 50, Cloud: 50,
            Tags:
            []Tag{  { Value: "unsupported-netcore",}, },
            Profiles:
            []Profile{  { Value: "netcore",}, },
            ...
            { Name: "dotnet-package-microsoft-data-sqlclient-sni", RuleType: "standard", Level: "", FileType: "(config$)", Target: "line", Type: "regex", DefaultPattern: ".*%s.*", Advice: "Not Supported in .NetCore", Effort: 10, Readiness: 10, Impact: "", Category: "package", Criticality: "medium",Container: 50, Cloud: 50,
            Tags:
            []Tag{  { Value: "unsupported-netcore",}, },
            Profiles:
            []Profile{  { Value: "netcore",}, },
            ...
            { Name: "dotnet-package-microsoft-diagnostics-tracing-eventsource-redist", RuleType: "standard", Level: "", FileType: "(config$)", Target: "line", Type: "regex", DefaultPattern: ".*%s.*", Advice: "Not Supported in .NetCore", Effort: 10, Readiness: 10, Impact: "", Category: "package", Criticality: "medium",Container: 50, Cloud: 50,
            Tags:
            []Tag{  { Value: "unsupported-netcore",}, },
            Profiles:
            []Profile{  { Value: "netcore",}, },
            ...
            { Name: "dotnet-package-microsoft-netframework-referenceassemblies-net45", RuleType: "standard", Level: "", FileType: "(config$)", Target: "line", Type: "regex", DefaultPattern: ".*%s.*", Advice: "Not Supported in .NetCore", Effort: 10, Readiness: 10, Impact: "", Category: "package", Criticality: "medium",Container: 50, Cloud: 50,
            Tags:
            []Tag{  { Value: "unsupported-netcore",}, },
            Profiles:
            []Profile{  { Value: "netcore",}, },
            ...
            { Name: "dotnet-package-microsoft-netframework-referenceassemblies-net461", RuleType: "standard", Level: "", FileType: "(config$)", Target: "line", Type: "regex", DefaultPattern: ".*%s.*", Advice: "Not Supported in .NetCore", Effort: 10, Readiness: 10, Impact: "", Category: "package", Criticality: "medium",Container: 50, Cloud: 50,
            Tags:
            []Tag{  { Value: "unsupported-netcore",}, },
            Profiles:
            []Profile{  { Value: "netcore",}, },
            ...
            { Name: "dotnet-package-microsoft-netframework-referenceassemblies-net462", RuleType: "standard", Level: "", FileType: "(config$)", Target: "line", Type: "regex", DefaultPattern: ".*%s.*", Advice: "Not Supported in .NetCore", Effort: 10, Readiness: 10, Impact: "", Category: "package", Criticality: "medium",Container: 50, Cloud: 50,
            Tags:
            []Tag{  { Value: "unsupported-netcore",}, },
            Profiles:
            []Profile{  { Value: "netcore",}, },
            ...
            { Name: "dotnet-package-microsoft-netframework-referenceassemblies-net472", RuleType: "standard", Level: "", FileType: "(config$)", Target: "line", Type: "regex", DefaultPattern: ".*%s.*", Advice: "Not Supported in .NetCore", Effort: 10, Readiness: 10, Impact: "", Category: "package", Criticality: "medium",Container: 50, Cloud: 50,
            Tags:
            []Tag{  { Value: "unsupported-netcore",}, },
            Profiles:
            []Profile{  { Value: "netcore",}, },
            ...
            { Name: "dotnet-package-microsoft-netframework-referenceassemblies-net48", RuleType: "standard", Level: "", FileType: "(config$)", Target: "line", Type: "regex", DefaultPattern: ".*%s.*", Advice: "Not Supported in .NetCore", Effort: 10, Readiness: 10, Impact: "", Category: "package", Criticality: "medium",Container: 50, Cloud: 50,
            Tags:
            []Tag{  { Value: "unsupported-netcore",}, },
            Profiles:
            []Profile{  { Value: "netcore",}, },
            ...
            { Name: "dotnet-package-microsoft-netframework-referenceassemblies", RuleType: "standard", Level: "", FileType: "(config$)", Target: "line", Type: "regex", DefaultPattern: ".*%s.*", Advice: "Not Supported in .NetCore", Effort: 10, Readiness: 10, Impact: "", Category: "package", Criticality: "medium",Container: 50, Cloud: 50,
            Tags:
            []Tag{  { Value: "unsupported-netcore",}, },
            Profiles:
            []Profile{  { Value: "netcore",}, },
            ...
            { Name: "dotnet-package-microsoft-owin-cors", RuleType: "standard", Level: "", FileType: "(config$)", Target: "line", Type: "regex", DefaultPattern: ".*%s.*", Advice: "Not Supported in .NetCore", Effort: 10, Readiness: 10, Impact: "", Category: "package", Criticality: "medium",Container: 50, Cloud: 50,
            Tags:
            []Tag{  { Value: "unsupported-netcore",}, },
            Profiles:
            []Profile{  { Value: "netcore",}, },
            ...
            { Name: "dotnet-package-microsoft-owin-diagnostics", RuleType: "standard", Level: "", FileType: "(config$)", Target: "line", Type: "regex", DefaultPattern: ".*%s.*", Advice: "Not Supported in .NetCore", Effort: 10, Readiness: 10, Impact: "", Category: "package", Criticality: "medium",Container: 50, Cloud: 50,
            Tags:
            []Tag{  { Value: "unsupported-netcore",}, },
            Profiles:
            []Profile{  { Value: "netcore",}, },
            ...
            { Name: "dotnet-package-microsoft-owin-filesystems", RuleType: "standard", Level: "", FileType: "(config$)", Target: "line", Type: "regex", DefaultPattern: ".*%s.*", Advice: "Not Supported in .NetCore", Effort: 10, Readiness: 10, Impact: "", Category: "package", Criticality: "medium",Container: 50, Cloud: 50,
            Tags:
            []Tag{  { Value: "unsupported-netcore",}, },
            Profiles:
            []Profile{  { Value: "netcore",}, },
            ...
            { Name: "dotnet-package-microsoft-owin-security-activedirectory", RuleType: "standard", Level: "", FileType: "(config$)", Target: "line", Type: "regex", DefaultPattern: ".*%s.*", Advice: "Not Supported in .NetCore", Effort: 10, Readiness: 10, Impact: "", Category: "package", Criticality: "medium",Container: 50, Cloud: 50,
            Tags:
            []Tag{  { Value: "unsupported-netcore",}, },
            Profiles:
            []Profile{  { Value: "netcore",}, },
            ...
            { Name: "dotnet-package-microsoft-owin-security-oauth", RuleType: "standard", Level: "", FileType: "(config$)", Target: "line", Type: "regex", DefaultPattern: ".*%s.*", Advice: "Not Supported in .NetCore", Effort: 10, Readiness: 10, Impact: "", Category: "package", Criticality: "medium",Container: 50, Cloud: 50,
            Tags:
            []Tag{  { Value: "unsupported-netcore",}, },
            Profiles:
            []Profile{  { Value: "netcore",}, },
            ...
            { Name: "dotnet-package-microsoft-owin-security-openidconnect", RuleType: "standard", Level: "", FileType: "(config$)", Target: "line", Type: "regex", DefaultPattern: ".*%s.*", Advice: "Not Supported in .NetCore", Effort: 10, Readiness: 10, Impact: "", Category: "package", Criticality: "medium",Container: 50, Cloud: 50,
            Tags:
            []Tag{  { Value: "unsupported-netcore",}, },
            Profiles:
            []Profile{  { Value: "netcore",}, },
            ...
            { Name: "dotnet-package-microsoft-owin-security-wsfederation", RuleType: "standard", Level: "", FileType: "(config$)", Target: "line", Type: "regex", DefaultPattern: ".*%s.*", Advice: "Not Supported in .NetCore", Effort: 10, Readiness: 10, Impact: "", Category: "package", Criticality: "medium",Container: 50, Cloud: 50,
            Tags:
            []Tag{  { Value: "unsupported-netcore",}, },
            Profiles:
            []Profile{  { Value: "netcore",}, },
            ...
            { Name: "dotnet-package-microsoft-owin-selfhost", RuleType: "standard", Level: "", FileType: "(config$)", Target: "line", Type: "regex", DefaultPattern: ".*%s.*", Advice: "Not Supported in .NetCore", Effort: 10, Readiness: 10, Impact: "", Category: "package", Criticality: "medium",Container: 50, Cloud: 50,
            Tags:
            []Tag{  { Value: "unsupported-netcore",}, },
            Profiles:
            []Profile{  { Value: "netcore",}, },
            ...
            { Name: "dotnet-package-microsoft-owin-staticfiles", RuleType: "standard", Level: "", FileType: "(config$)", Target: "line", Type: "regex", DefaultPattern: ".*%s.*", Advice: "Not Supported in .NetCore", Effort: 10, Readiness: 10, Impact: "", Category: "package", Criticality: "medium",Container: 50, Cloud: 50,
            Tags:
            []Tag{  { Value: "unsupported-netcore",}, },
            Profiles:
            []Profile{  { Value: "netcore",}, },
            ...
            { Name: "dotnet-package-microsoft-owin-testing", RuleType: "standard", Level: "", FileType: "(config$)", Target: "line", Type: "regex", DefaultPattern: ".*%s.*", Advice: "Not Supported in .NetCore", Effort: 10, Readiness: 10, Impact: "", Category: "package", Criticality: "medium",Container: 50, Cloud: 50,
            Tags:
            []Tag{  { Value: "unsupported-netcore",}, },
            Profiles:
            []Profile{  { Value: "netcore",}, },
            ...
            { Name: "dotnet-package-microsoft-servicefabric-aspnetcore-abstractions", RuleType: "standard", Level: "", FileType: "(config$)", Target: "line", Type: "regex", DefaultPattern: ".*%s.*", Advice: "Not Supported in .NetCore", Effort: 10, Readiness: 10, Impact: "", Category: "package", Criticality: "medium",Container: 50, Cloud: 50,
            Tags:
            []Tag{  { Value: "unsupported-netcore",}, },
            Profiles:
            []Profile{  { Value: "netcore",}, },
            ...
            { Name: "dotnet-package-microsoft-servicefabric-aspnetcore-kestrel", RuleType: "standard", Level: "", FileType: "(config$)", Target: "line", Type: "regex", DefaultPattern: ".*%s.*", Advice: "Not Supported in .NetCore", Effort: 10, Readiness: 10, Impact: "", Category: "package", Criticality: "medium",Container: 50, Cloud: 50,
            Tags:
            []Tag{  { Value: "unsupported-netcore",}, },
            Profiles:
            []Profile{  { Value: "netcore",}, },
            ...
            { Name: "dotnet-package-microsoft-visualstudio-azure-containers-tools-targets", RuleType: "standard", Level: "", FileType: "(config$)", Target: "line", Type: "regex", DefaultPattern: ".*%s.*", Advice: "Not Supported in .NetCore", Effort: 10, Readiness: 10, Impact: "", Category: "package", Criticality: "medium",Container: 50, Cloud: 50,
            Tags:
            []Tag{  { Value: "unsupported-netcore",}, },
            Profiles:
            []Profile{  { Value: "netcore",}, },
            ...
            { Name: "dotnet-package-microsoft-visualstudio-azure-fabric-msbuild", RuleType: "standard", Level: "", FileType: "(config$)", Target: "line", Type: "regex", DefaultPattern: ".*%s.*", Advice: "Not Supported in .NetCore", Effort: 10, Readiness: 10, Impact: "", Category: "package", Criticality: "medium",Container: 50, Cloud: 50,
            Tags:
            []Tag{  { Value: "unsupported-netcore",}, },
            Profiles:
            []Profile{  { Value: "netcore",}, },
            ...
            { Name: "dotnet-package-microsoft-visualstudio-slowcheetah", RuleType: "standard", Level: "", FileType: "(config$)", Target: "line", Type: "regex", DefaultPattern: ".*%s.*", Advice: "Not Supported in .NetCore", Effort: 10, Readiness: 10, Impact: "", Category: "package", Criticality: "medium",Container: 50, Cloud: 50,
            Tags:
            []Tag{  { Value: "unsupported-netcore",}, },
            Profiles:
            []Profile{  { Value: "netcore",}, },
            ...
            { Name: "dotnet-package-microsoft-web-redissessionstateprovider", RuleType: "standard", Level: "", FileType: "(config$)", Target: "line", Type: "regex", DefaultPattern: ".*%s.*", Advice: "Not Supported in .NetCore", Effort: 10, Readiness: 10, Impact: "", Category: "package", Criticality: "medium",Container: 50, Cloud: 50,
            Tags:
            []Tag{  { Value: "unsupported-netcore",}, },
            Profiles:
            []Profile{  { Value: "netcore",}, },
            ...
            { Name: "dotnet-package-miniprofiler", RuleType: "standard", Level: "", FileType: "(config$)", Target: "line", Type: "regex", DefaultPattern: ".*%s.*", Advice: "Not Supported in .NetCore", Effort: 10, Readiness: 10, Impact: "", Category: "package", Criticality: "medium",Container: 50, Cloud: 50,
            Tags:
            []Tag{  { Value: "unsupported-netcore",}, },
            Profiles:
            []Profile{  { Value: "netcore",}, },
            ...
            { Name: "dotnet-package-ninject-mvc5", RuleType: "standard", Level: "", FileType: "(config$)", Target: "line", Type: "regex", DefaultPattern: ".*%s.*", Advice: "Not Supported in .NetCore", Effort: 10, Readiness: 10, Impact: "", Category: "package", Criticality: "medium",Container: 50, Cloud: 50,
            Tags:
            []Tag{  { Value: "unsupported-netcore",}, },
            Profiles:
            []Profile{  { Value: "netcore",}, },
            ...
            { Name: "dotnet-package-ninject-web-common-webhost", RuleType: "standard", Level: "", FileType: "(config$)", Target: "line", Type: "regex", DefaultPattern: ".*%s.*", Advice: "Not Supported in .NetCore", Effort: 10, Readiness: 10, Impact: "", Category: "package", Criticality: "medium",Container: 50, Cloud: 50,
            Tags:
            []Tag{  { Value: "unsupported-netcore",}, },
            Profiles:
            []Profile{  { Value: "netcore",}, },
            ...
            { Name: "dotnet-package-ninject-web-webapi", RuleType: "standard", Level: "", FileType: "(config$)", Target: "line", Type: "regex", DefaultPattern: ".*%s.*", Advice: "Not Supported in .NetCore", Effort: 10, Readiness: 10, Impact: "", Category: "package", Criticality: "medium",Container: 50, Cloud: 50,
            Tags:
            []Tag{  { Value: "unsupported-netcore",}, },
            Profiles:
            []Profile{  { Value: "netcore",}, },
            ...
            { Name: "dotnet-package-nlog-extended", RuleType: "standard", Level: "", FileType: "(config$)", Target: "line", Type: "regex", DefaultPattern: ".*%s.*", Advice: "Not Supported in .NetCore", Effort: 10, Readiness: 10, Impact: "", Category: "package", Criticality: "medium",Container: 50, Cloud: 50,
            Tags:
            []Tag{  { Value: "unsupported-netcore",}, },
            Profiles:
            []Profile{  { Value: "netcore",}, },
            ...
            { Name: "dotnet-package-nlog-web", RuleType: "standard", Level: "", FileType: "(config$)", Target: "line", Type: "regex", DefaultPattern: ".*%s.*", Advice: "Not Supported in .NetCore", Effort: 10, Readiness: 10, Impact: "", Category: "package", Criticality: "medium",Container: 50, Cloud: 50,
            Tags:
            []Tag{  { Value: "unsupported-netcore",}, },
            Profiles:
            []Profile{  { Value: "netcore",}, },
            ...
            { Name: "dotnet-package-portable-dataannotations", RuleType: "standard", Level: "", FileType: "(config$)", Target: "line", Type: "regex", DefaultPattern: ".*%s.*", Advice: "Not Supported in .NetCore", Effort: 10, Readiness: 10, Impact: "", Category: "package", Criticality: "medium",Container: 50, Cloud: 50,
            Tags:
            []Tag{  { Value: "unsupported-netcore",}, },
            Profiles:
            []Profile{  { Value: "netcore",}, },
            ...
            { Name: "dotnet-package-razorengine", RuleType: "standard", Level: "", FileType: "(config$)", Target: "line", Type: "regex", DefaultPattern: ".*%s.*", Advice: "Not Supported in .NetCore", Effort: 10, Readiness: 10, Impact: "", Category: "package", Criticality: "medium",Container: 50, Cloud: 50,
            Tags:
            []Tag{  { Value: "unsupported-netcore",}, },
            Profiles:
            []Profile{  { Value: "netcore",}, },
            ...
            { Name: "dotnet-package-runtime-aot-system-reflection-primitives", RuleType: "standard", Level: "", FileType: "(config$)", Target: "line", Type: "regex", DefaultPattern: ".*%s.*", Advice: "Not Supported in .NetCore", Effort: 10, Readiness: 10, Impact: "", Category: "package", Criticality: "medium",Container: 50, Cloud: 50,
            Tags:
            []Tag{  { Value: "unsupported-netcore",}, },
            Profiles:
            []Profile{  { Value: "netcore",}, },
            ...
            { Name: "dotnet-package-sqlitepclraw-provider-e_sqlite3-net45", RuleType: "standard", Level: "", FileType: "(config$)", Target: "line", Type: "regex", DefaultPattern: ".*%s.*", Advice: "Not Supported in .NetCore", Effort: 10, Readiness: 10, Impact: "", Category: "package", Criticality: "medium",Container: 50, Cloud: 50,
            Tags:
            []Tag{  { Value: "unsupported-netcore",}, },
            Profiles:
            []Profile{  { Value: "netcore",}, },
            ...
            { Name: "dotnet-package-stub-system-data-sqlite-core-netframework", RuleType: "standard", Level: "", FileType: "(config$)", Target: "line", Type: "regex", DefaultPattern: ".*%s.*", Advice: "Not Supported in .NetCore", Effort: 10, Readiness: 10, Impact: "", Category: "package", Criticality: "medium",Container: 50, Cloud: 50,
            Tags:
            []Tag{  { Value: "unsupported-netcore",}, },
            Profiles:
            []Profile{  { Value: "netcore",}, },
            ...
            { Name: "dotnet-package-system-data-sqlite-linq", RuleType: "standard", Level: "", FileType: "(config$)", Target: "line", Type: "regex", DefaultPattern: ".*%s.*", Advice: "Not Supported in .NetCore", Effort: 10, Readiness: 10, Impact: "", Category: "package", Criticality: "medium",Container: 50, Cloud: 50,
            Tags:
            []Tag{  { Value: "unsupported-netcore",}, },
            Profiles:
            []Profile{  { Value: "netcore",}, },
            ...
            { Name: "dotnet-package-system-net-http-formatting-extension", RuleType: "standard", Level: "", FileType: "(config$)", Target: "line", Type: "regex", DefaultPattern: ".*%s.*", Advice: "Not Supported in .NetCore", Effort: 10, Readiness: 10, Impact: "", Category: "package", Criticality: "medium",Container: 50, Cloud: 50,
            Tags:
            []Tag{  { Value: "unsupported-netcore",}, },
            Profiles:
            []Profile{  { Value: "netcore",}, },
            ...
            { Name: "dotnet-package-system-reactive-windows-threading", RuleType: "standard", Level: "", FileType: "(config$)", Target: "line", Type: "regex", DefaultPattern: ".*%s.*", Advice: "Not Supported in .NetCore", Effort: 10, Readiness: 10, Impact: "", Category: "package", Criticality: "medium",Container: 50, Cloud: 50,
            Tags:
            []Tag{  { Value: "unsupported-netcore",}, },
            Profiles:
            []Profile{  { Value: "netcore",}, },
            ...
            { Name: "dotnet-package-telerik-dataaccess-core", RuleType: "standard", Level: "", FileType: "(config$)", Target: "line", Type: "regex", DefaultPattern: ".*%s.*", Advice: "Not Supported in .NetCore", Effort: 10, Readiness: 10, Impact: "", Category: "package", Criticality: "medium",Container: 50, Cloud: 50,
            Tags:
            []Tag{  { Value: "unsupported-netcore",}, },
            Profiles:
            []Profile{  { Value: "netcore",}, },
            ...
            { Name: "dotnet-package-telerik-dataaccess-web", RuleType: "standard", Level: "", FileType: "(config$)", Target: "line", Type: "regex", DefaultPattern: ".*%s.*", Advice: "Not Supported in .NetCore", Effort: 10, Readiness: 10, Impact: "", Category: "package", Criticality: "medium",Container: 50, Cloud: 50,
            Tags:
            []Tag{  { Value: "unsupported-netcore",}, },
            Profiles:
            []Profile{  { Value: "netcore",}, },
            ...
            { Name: "dotnet-package-unity-aspnet-webapi", RuleType: "standard", Level: "", FileType: "(config$)", Target: "line", Type: "regex", DefaultPattern: ".*%s.*", Advice: "Not Supported in .NetCore", Effort: 10, Readiness: 10, Impact: "", Category: "package", Criticality: "medium",Container: 50, Cloud: 50,
            Tags:
            []Tag{  { Value: "unsupported-netcore",}, },
            Profiles:
            []Profile{  { Value: "netcore",}, },
            ...
            { Name: "dotnet-package-unity-mvc", RuleType: "standard", Level: "", FileType: "(config$)", Target: "line", Type: "regex", DefaultPattern: ".*%s.*", Advice: "Not Supported in .NetCore", Effort: 10, Readiness: 10, Impact: "", Category: "package", Criticality: "medium",Container: 50, Cloud: 50,
            Tags:
            []Tag{  { Value: "unsupported-netcore",}, },
            Profiles:
            []Profile{  { Value: "netcore",}, },
            ...
            { Name: "dotnet-reflection-assembly", RuleType: "standard", Level: "", FileType: "(cs$|vb$)", Target: "line", Type: "regex", DefaultPattern: ".*%s.*", Advice: "Use AssemblyLoadContext. Evidence is not supported in .NET Core.", Effort: 10, Readiness: 10, Impact: "", Category: "API", Criticality: "medium",Container: 50, Cloud: 50,
            Tags:
            []Tag{  { Value: "api",}, { Value: "unsupported-netcore",}, },
            Profiles:
            []Profile{  { Value: "netcore",}, },
            ...
            { Name: "dotnet-script-blocks", RuleType: "standard", Level: "", FileType: "(xsl)", Target: "line", Type: "regex", DefaultPattern: ".*%s.*", Advice: "Script blocks are supported only in .NET Framework. They are not supported on .NET Core or .NET 5 or later.", Effort: 10, Readiness: 10, Impact: "", Category: "WCF", Criticality: "medium",Container: 50, Cloud: 50,
            Tags:
            ...
            { Name: "dotnet-serialization", RuleType: "standard", Level: "", FileType: "(cs$|vb$)", Target: "line", Type: "regex", DefaultPattern: ".*%s.*", Advice: "Not supported in .netCore", Effort: 10, Readiness: 1, Impact: "", Category: "unsupported-module", Criticality: "medium",Container: 50, Cloud: 50,
            Tags:
            ...
            { Name: "dotnet-system-speech", RuleType: "standard", Level: "", FileType: "(cs$)", Target: "line", Type: "regex", DefaultPattern: ".*%s.*", Advice: "System.Speech won't be ported to .NET Core. See https://aka.ms/unsupported-netfx-api.", Effort: 10, Readiness: 10, Impact: "", Category: "API", Criticality: "medium",Container: 50, Cloud: 50,
            Tags:
            []Tag{  { Value: "api",}, { Value: "unsupported-netcore",}, },
            Profiles:
            []Profile{  { Value: "netcore",}, },
            ...
            { Name: "dotnet-vb-razor-view-engine", RuleType: "standard", Level: "", FileType: "(vbhtml$)", Target: "line", Type: "regex", DefaultPattern: "(%s)", Advice: "Not supported in .netCore https://aka.ms/vb-angular-and-web-api", Effort: 10, Readiness: 9, Impact: "", Category: "unsupported-netcore.", Criticality: "medium",Container: 50, Cloud: 50,
            Tags:
            []Tag{  { Value: "asp",}, { Value: "asp-web-form",}, { Value: "unsupported-netcore",}, },
            Profiles:
            []Profile{  { Value: "netcore",}, },
            ...
            { Name: "dotnet-wcf-service-model-config", RuleType: "standard", Level: "", FileType: "config$", Target: "file", Type: "xpath", DefaultPattern: "", Advice: "Upgrade to CoreWCF https://devblogs.microsoft.com/dotnet/upgrading-a-wcf-service-to-dotnet-6/", Effort: 10, Readiness: 9, Impact: "", Category: "unsupported-iis-module", Criticality: "medium",Container: 50, Cloud: 50,
            Tags:
            []Tag{  { Value: "windows-wcf",}, { Value: "communication",}, { Value: "api",}, { Value: "unsupported-netcore",}, },
            Profiles:
            []Profile{  { Value: "netcore",}, },
            ...
            { Name: "dotnet-wcf-service-model", RuleType: "standard", Level: "", FileType: "(cs$|vb$)", Target: "line", Type: "regex", DefaultPattern: ".*%s.*", Advice: "Upgrade to CoreWCF https://devblogs.microsoft.com/dotnet/upgrading-a-wcf-service-to-dotnet-6/", Effort: 10, Readiness: 10, Impact: "", Category: "WCF", Criticality: "medium",Container: 50, Cloud: 50,
            Tags:
            []Tag{  { Value: "windows-wcf",}, { Value: "communication",}, { Value: "api",}, { Value: "unsupported-netcore",}, },
            Profiles:
            []Profile{  { Value: "netcore",}, },
            ...
            { Name: "dotnet-wf-activity", RuleType: "standard", Level: "", FileType: "(cs$)", Target: "line", Type: "regex", DefaultPattern: ".*%s.*", Advice: "Windows Workflow Foundation (WF) won't be ported to .NET Core. See https://aka.ms/unsupported-netfx-api.", Effort: 10, Readiness: 10, Impact: "", Category: "WF", Criticality: "medium",Container: 50, Cloud: 50,
            Tags:
            []Tag{  { Value: "api",}, { Value: "unsupported-netcore",}, },
            Profiles:
            []Profile{  { Value: "netcore",}, },
            ...
            { Name: "dotnet-wf-integration", RuleType: "standard", Level: "", FileType: "(cs$)", Target: "line", Type: "regex", DefaultPattern: ".*%s.*", Advice: "Windows Workflow Foundation (WF) won't be ported to .NET Core. See https://aka.ms/unsupported-netfx-api.", Effort: 10, Readiness: 10, Impact: "", Category: "WF", Criticality: "medium",Container: 50, Cloud: 50,
            Tags:
            []Tag{  { Value: "api",}, { Value: "unsupported-netcore",}, },
            Profiles:
            []Profile{  { Value: "netcore",}, },
            ...
            { Name: "dotnet-wf-presentation", RuleType: "standard", Level: "", FileType: "(xaml$)", Target: "line", Type: "regex", DefaultPattern: ".*%s.*", Advice: "Windows Workflow Foundation (WF) won't be ported to .NET Core. See https://aka.ms/unsupported-netfx-api.", Effort: 500, Readiness: 1, Impact: "", Category: "WF", Criticality: "medium",Container: 50, Cloud: 50,
            Tags:
            ...
            { Name: "dotnet-windows-enterprise-services", RuleType: "standard", Level: "", FileType: "(cs$|vb$)", Target: "line", Type: "regex", DefaultPattern: ".*%s.*", Advice: "Not Supported on .Net Core", Effort: 10, Readiness: 9, Impact: "", Category: "unsupported-netcore", Criticality: "medium",Container: 50, Cloud: 50,
            Tags:
            []Tag{  { Value: "com+",}, { Value: "api",}, { Value: "distributed-transaction",}, { Value: "unsupported-netcore",}, },
            Profiles:
            []Profile{  { Value: "netcore",}, },
            ...
            { Name: "dotnet-workflow", RuleType: "standard", Level: "", FileType: "(cs$)", Target: "line", Type: "regex", DefaultPattern: ".*%s.*", Advice: "Windows Workflow Foundation (WF) won't be ported to .NET Core. See https://aka.ms/unsupported-netfx-api.", Effort: 10, Readiness: 10, Impact: "", Category: "API", Criticality: "medium",Container: 50, Cloud: 50,
            Tags:
            []Tag{  { Value: "api",}, { Value: "unsupported-netcore",}, },
            Profiles:
            []Profile{  { Value: "netcore",}, },
            ...
            { Name: "php-deprecated-feature-parse_str", RuleType: "standard", Level: "", FileType: "php$", Target: "line", Type: "regex", DefaultPattern: "([^_]%s)\\s*\\(.*[^,]\\)", Advice: "parse_str() without second argument is deprecated", Effort: 3, Readiness: 1000, Impact: "", Category: "deprecation", Criticality: "medium",Container: 50, Cloud: 50,
            Tags:
            ...
            { Name: "php-goto-stmt-should-not-be-used", RuleType: "standard", Level: "", FileType: "ini$", Target: "line", Type: "regex", DefaultPattern: "\\s*(%s\\s*.+)", Advice: "goto is an unstructured control flow statement. It makes code less readable and maintainable. Structured control flow statements such as if, for, while, continue or break should be used instead.", Effort: 3, Readiness: 1000, Impact: "", Category: "code_smell", Criticality: "medium",Container: 50, Cloud: 50,
            Tags:
            ...
            { Name: "php-php-url-not-hardcoded", RuleType: "standard", Level: "", FileType: "php$", Target: "line", Type: "regex", DefaultPattern: ".*(%s://).*", Advice: "Url Hardcoding in code is anti-pattern", Effort: 2, Readiness: 1000, Impact: "", Category: "anti-pattern", Criticality: "medium",Container: 50, Cloud: 50,
            Tags:
            []Tag{  { Value: "code_smell",}, },
            Profiles:
            []Profile{  { Value: "cloud-suitability",}, },
            ...
            { Name: "plaintext-creds", RuleType: "standard", Level: "", FileType: "", Target: "line", Type: "regex", DefaultPattern: "(%s)\\s*=+\\s*[\"''][^${[(\\s][^\"${[(\\s].*", Advice: "Found plain text crdentials. Never save passwords or login information in files. Make configurable, put into environment variables or config maps in a kubernetes like environment. Credentials could also be set and retrieved from cloud friendly crdential vaults.", Effort: 0, Readiness: 9, Impact: "", Category: "security", Criticality: "medium",Container: 50, Cloud: 50,
            Tags:
            []Tag{  { Value: "security",}, },
            Profiles:
            []Profile{  { Value: "cloud-suitability",}, },
            ...
            { Name: "python-cf", RuleType: "standard", Level: "", FileType: "py$", Target: "line", Type: "regex", DefaultPattern: "^.*import(\\s*|=\")%s.*$", Advice: "Check for cloud foundry support.", Effort: -10, Readiness: 10, Impact: "", Category: "cloud-foundry", Criticality: "medium",Container: 50, Cloud: 50,
            Tags:
            ...
            { Name: "python-db-peewee", RuleType: "standard", Level: "", FileType: "py$", Target: "line", Type: "regex", DefaultPattern: "^.*import(\\s*|=\")%s.*$", Advice: "Check target platform has support for this library", Effort: 1, Readiness: 10, Impact: "", Category: "database", Criticality: "medium",Container: 50, Cloud: 50,
            Tags:
            []Tag{  { Value: "peewee",}, },
            Profiles:
            []Profile{  { Value: "cloud-suitability",}, },
            ...
            { Name: "python-db-redis", RuleType: "standard", Level: "", FileType: "py$", Target: "line", Type: "regex", DefaultPattern: "^.*import(\\s*|=\")%s.*$", Advice: "Redis is being used", Effort: 1, Readiness: 10, Impact: "", Category: "database", Criticality: "medium",Container: 50, Cloud: 50,
            Tags:
            []Tag{  { Value: "redis",}, },
            Profiles:
            []Profile{  { Value: "cloud-suitability",}, },
            ...
            { Name: "python-fileIO", RuleType: "standard", Level: "", FileType: "py$", Target: "line", Type: "regex", DefaultPattern: "^.*[ .]%s[ (].*", Advice: "Relying on the local filesystem to store state is unreliable in a cloud platform. Since containers are immutable, restarts will lose any written changes. Refactor this logic to use an external service to store state.", Effort: 8, Readiness: 8, Impact: "", Category: "io", Criticality: "medium",Container: 50, Cloud: 50,
            Tags:
            []Tag{  { Value: "io",}, },
            Profiles:
            []Profile{  { Value: "cloud-suitability",}, },
            ...
            { Name: "python-rabbitmq", RuleType: "standard", Level: "", FileType: "py$", Target: "line", Type: "regex", DefaultPattern: "^.*import(\\s*|=\")%s.*$", Advice: "RabbitMq messaging is used", Effort: 1, Readiness: 10, Impact: "", Category: "services", Criticality: "medium",Container: 50, Cloud: 50,
            Tags:
            []Tag{  { Value: "rabbitmq",}, },
            Profiles:
            []Profile{  { Value: "cloud-suitability",}, },
            ...
            { Name: "python-redis", RuleType: "standard", Level: "", FileType: "py$", Target: "line", Type: "regex", DefaultPattern: "(import)\\s+(%s)", Advice: "Redis is being used", Effort: 1, Readiness: 10, Impact: "", Category: "services", Criticality: "medium",Container: 50, Cloud: 50,
            Tags:
            []Tag{  { Value: "redis",}, },
            Profiles:
            []Profile{  { Value: "cloud-suitability",}, },
            ...
            { Name: "python-sqlite", RuleType: "standard", Level: "", FileType: "py$", Target: "line", Type: "regex", DefaultPattern: "(%s)", Advice: "Consider migration to an external database.", Effort: 6, Readiness: 8, Impact: "", Category: "DatabaseAccess", Criticality: "medium",Container: 50, Cloud: 50,
            Tags:
            ...
            { Name: "tas-environment-cfenv-gradle", RuleType: "standard", Level: "", FileType: "gradle$", Target: "line", Type: "regex", DefaultPattern: "^.*%s", Advice: "Application appears to be using cf env library to inject environment variables provided by TAS.", Effort: 1, Readiness: 7, Impact: "", Category: "tas", Criticality: "medium",Container: 50, Cloud: 50,
            Tags:
            ...
            { Name: "tas-environment-cfenv-maven", RuleType: "standard", Level: "", FileType: "xml$", Target: "line", Type: "regex", DefaultPattern: "(>.*%s<)", Advice: "Application appears to be using cf env library to inject environment variables provided by TAS.", Effort: 1, Readiness: 7, Impact: "", Category: "tas", Criticality: "medium",Container: 50, Cloud: 50,
            Tags:
            []Tag{  { Value: "tas",}, { Value: "env-config",}, },
            Profiles:
            []Profile{  { Value: "tas",}, },
            ...
            { Name: "websphere-cluster-jacl", RuleType: "standard", Level: "", FileType: "jacl$", Target: "line", Type: "regex", DefaultPattern: "^ *%s.*", Advice: "Websphere clusters cannot run in K8S", Effort: 1, Readiness: 0, Impact: "", Category: "wscluster", Criticality: "medium",Container: 50, Cloud: 50,
            Tags:
            ...
            { Name: "wsdl-soap", RuleType: "standard", Level: "", FileType: "wsdl$", Target: "file", Type: "regex", DefaultPattern: "", Advice: "Consider upgrading to cloud friendly communication protocol", Effort: 4, Readiness: 3, Impact: "", Category: "soap", Criticality: "medium",Container: 50, Cloud: 50,
            Tags:
            ...
            { Name: "xml-activeMQ", RuleType: "standard", Level: "", FileType: "xml$", Target: "line", Type: "regex", DefaultPattern: "(%s)", Advice: "Make sure that Active MQ broker is available on target platform", Effort: 5, Readiness: 10, Impact: "", Category: "mq", Criticality: "medium",Container: 50, Cloud: 50,
            Tags:
            ...
            { Name: "xml-clientCert", RuleType: "standard", Level: "", FileType: "xml$", Target: "line", Type: "regex", DefaultPattern: "(%s)", Advice: "Avoid reliance on SSL", Effort: 5, Readiness: 10, Impact: "", Category: "security", Criticality: "medium",Container: 50, Cloud: 50,
            Tags:
            ...
            { Name: "xml-ehcache-Config", RuleType: "standard", Level: "", FileType: "xml$", Target: "line", Type: "regex", DefaultPattern: "(%s)", Advice: "Consider external cache provider", Effort: 50, Readiness: 10, Impact: "", Category: "cache", Criticality: "medium",Container: 50, Cloud: 50,
            Tags:
            []Tag{  { Value: "cache",}, { Value: "ehcache",}, },
            Profiles:
            []Profile{  { Value: "cloud-suitability",}, },
            ...
            { Name: "xml-ejb-2-1", RuleType: "standard", Level: "", FileType: "xml$", Target: "line", Type: "regex", DefaultPattern: "(%s)", Advice: "Application server coupling", Effort: 10, Readiness: 10, Impact: "", Category: "ejb", Criticality: "medium",Container: 50, Cloud: 50,
            Tags:
            ...
            { Name: "xml-ejb-3-0", RuleType: "standard", Level: "", FileType: "xml$", Target: "line", Type: "regex", DefaultPattern: "(%s)", Advice: "Application server coupling", Effort: 7, Readiness: 7, Impact: "", Category: "ejb", Criticality: "medium",Container: 50, Cloud: 50,
            Tags:
            ...
            { Name: "xml-ejb-3-1", RuleType: "standard", Level: "", FileType: "xml$", Target: "line", Type: "regex", DefaultPattern: "(%s)", Advice: "Application server coupling", Effort: 7, Readiness: 7, Impact: "", Category: "ejb", Criticality: "medium",Container: 50, Cloud: 50,
            Tags:
            ...
            { Name: "xml-ejb-3-2", RuleType: "standard", Level: "", FileType: "xml$", Target: "line", Type: "regex", DefaultPattern: "(%s)", Advice: "Application server coupling", Effort: 7, Readiness: 7, Impact: "", Category: "ejb", Criticality: "medium",Container: 50, Cloud: 50,
            Tags:
            []Tag{  { Value: "ejb-lite",}, { Value: "javaee",}, },
            Profiles:
            []Profile{  { Value: "cloud-suitability",}, },
            ...
            { Name: "xml-ejb-mdb-import", RuleType: "standard", Level: "", FileType: "xml$", Target: "line", Type: "regex", DefaultPattern: "(%s)", Advice: "Application server coupling", Effort: 7, Readiness: 7, Impact: "", Category: "MDB", Criticality: "medium",Container: 50, Cloud: 50,
            Tags:
            ...
            { Name: "java-mdb", RuleType: "standard", Level: "", FileType: "xml$", Target: "line", Type: "regex", DefaultPattern: "(%s)", Advice: "Application server coupling", Effort: 7, Readiness: 7, Impact: "", Category: "MDB", Criticality: "medium",Container: 50, Cloud: 50,
            Tags:
            []Tag{  { Value: "mdb",}, { Value: "ejb",}, { Value: "javaee",}, { Value: "fullprofile",}, },
            Profiles:
            []Profile{  { Value: "cloud-suitability",}, },
            ...
            { Name: "xml-ejb-resource-mgr-aut", RuleType: "standard", Level: "", FileType: "xml$", Target: "line", Type: "regex", DefaultPattern: "(%s)", Advice: "Security implementation might need to be refactored", Effort: 10, Readiness: 10, Impact: "", Category: "security", Criticality: "medium",Container: 50, Cloud: 50,
            Tags:
            ...
            { Name: "xml-facelets", RuleType: "standard", Level: "", FileType: "xml$", Target: "line", Type: "regex", DefaultPattern: "(%s)", Advice: "Consider upgrading to modern UI framework", Effort: 2, Readiness: 2, Impact: "", Category: "Facelets", Criticality: "medium",Container: 50, Cloud: 50,
            Tags:
            ...
            { Name: "xml-jboss", RuleType: "standard", Level: "", FileType: "xml$", Target: "file", Type: "simple-text", DefaultPattern: "", Advice: "Application Server coupling", Effort: 50, Readiness: 5, Impact: "", Category: "Jboss", Criticality: "medium",Container: 50, Cloud: 50,
            Tags:
            ...
            { Name: "xml-jee", RuleType: "standard", Level: "", FileType: "xml$", Target: "file", Type: "simple-text", DefaultPattern: "", Advice: "Convert to Spring based application configuration or use importResource", Effort: 20, Readiness: 8, Impact: "", Category: "Config", Criticality: "medium",Container: 50, Cloud: 50,
            Tags:
            ...
            { Name: "xml-localJNDI", RuleType: "standard", Level: "", FileType: "xml$", Target: "line", Type: "regex", DefaultPattern: "(%s)", Advice: "WebSphere does not allow local JNDI, refer to documentation", Effort: 10, Readiness: 10, Impact: "", Category: "jndi", Criticality: "medium",Container: 50, Cloud: 50,
            Tags:
            ...
            { Name: "xml-messageDrivenBeans", RuleType: "standard", Level: "", FileType: "xml$", Target: "line", Type: "regex", DefaultPattern: "(%s)", Advice: "Application server coupling", Effort: 10, Readiness: 10, Impact: "", Category: "mdb", Criticality: "medium",Container: 50, Cloud: 50,
            Tags:
            ...
            { Name: "xml-myfaces", RuleType: "standard", Level: "", FileType: "xml$", Target: "line", Type: "regex", DefaultPattern: "(%s)", Advice: "Consider upgrading to modern UI framework", Effort: 5, Readiness: 2, Impact: "", Category: "myfaces", Criticality: "medium",Container: 50, Cloud: 50,
            Tags:
            []Tag{  { Value: "jsf",}, },
            Profiles:
            []Profile{  { Value: "cloud-suitability",}, },
            ...
            { Name: "xml-servlet-3-0", RuleType: "standard", Level: "", FileType: "xml$", Target: "line", Type: "regex", DefaultPattern: "(%s)", Advice: "Web Server coupling. Consider upgrading to modern framework.", Effort: 8, Readiness: 10, Impact: "", Category: "servlet", Criticality: "medium",Container: 50, Cloud: 50,
            Tags:
            []Tag{  { Value: "servlet",}, { Value: "web-container",}, },
            Profiles:
            []Profile{  { Value: "cloud-suitability",}, },
            ...
            { Name: "xml-servlet-3-1", RuleType: "standard", Level: "", FileType: "xml$", Target: "line", Type: "regex", DefaultPattern: "(%s)", Advice: "Web Server coupling. Consider upgrading to modern framework.", Effort: 5, Readiness: 5, Impact: "", Category: "servlet", Criticality: "medium",Container: 50, Cloud: 50,
            Tags:
            []Tag{  { Value: "servlet",}, { Value: "web-container",}, },
            Profiles:
            []Profile{  { Value: "cloud-suitability",}, },
            ...
            { Name: "xml-struts-1-1", RuleType: "standard", Level: "", FileType: "xml$", Target: "line", Type: "regex", DefaultPattern: "(%s)", Advice: "Consider upgrading to modern cloud native UI framework", Effort: 10, Readiness: 10, Impact: "", Category: "struts", Criticality: "medium",Container: 50, Cloud: 50,
            Tags:
            ...
            { Name: "xml-struts-2-2", RuleType: "standard", Level: "", FileType: "xml$", Target: "line", Type: "regex", DefaultPattern: "(%s)", Advice: "Consider upgrading to modern cloud native UI framework", Effort: 7, Readiness: 7, Impact: "", Category: "struts", Criticality: "medium",Container: 50, Cloud: 50,
            Tags:
            []Tag{  { Value: "struts",}, { Value: "ui",}, },
            Profiles:
            []Profile{  { Value: "cloud-suitability",}, },
            ...
            { Name: "xml-struts-2-3", RuleType: "standard", Level: "", FileType: "xml$", Target: "line", Type: "regex", DefaultPattern: "(%s)", Advice: "Consider upgrading to modern cloud native UI framework", Effort: 7, Readiness: 7, Impact: "", Category: "struts", Criticality: "medium",Container: 50, Cloud: 50,
            Tags:
            []Tag{  { Value: "struts",}, { Value: "ui",}, },
            Profiles:
            []Profile{  { Value: "cloud-suitability",}, },
            ...
            { Name: "xml-struts-2-4", RuleType: "standard", Level: "", FileType: "xml$", Target: "line", Type: "regex", DefaultPattern: "(%s)", Advice: "Consider upgrading to modern cloud native UI framework", Effort: 7, Readiness: 7, Impact: "", Category: "struts", Criticality: "medium",Container: 50, Cloud: 50,
            Tags:
            []Tag{  { Value: "struts",}, { Value: "ui",}, },
            Profiles:
            []Profile{  { Value: "cloud-suitability",}, },
            ...
            { Name: "xml-struts-2-5", RuleType: "standard", Level: "", FileType: "xml$", Target: "line", Type: "regex", DefaultPattern: "(%s)", Advice: "Consider upgrading to modern cloud native UI framework", Effort: 7, Readiness: 7, Impact: "", Category: "struts", Criticality: "medium",Container: 50, Cloud: 50,
            Tags:
            []Tag{  { Value: "struts",}, { Value: "ui",}, },
            Profiles:
            []Profile{  { Value: "cloud-suitability",}, },
            ...
            { Name: "xml-struts-tiles", RuleType: "standard", Level: "", FileType: "xml$", Target: "line", Type: "regex", DefaultPattern: "(%s)", Advice: "Consider upgrading to modern cloud native UI framework", Effort: 5, Readiness: 2, Impact: "", Category: "tiles", Criticality: "medium",Container: 50, Cloud: 50,
            Tags:
            ...
            { Name: "xml-transportSecurity", RuleType: "standard", Level: "", FileType: "xml$", Target: "line", Type: "regex", DefaultPattern: "(%s)", Advice: "Application Server coupling", Effort: 2, Readiness: 10, Impact: "", Category: "security", Criticality: "medium",Container: 50, Cloud: 50,
            Tags:
            []Tag{  { Value: "security",}, { Value: "web-app",}, },
            Profiles:
            []Profile{  { Value: "cloud-suitability",}, },
            ...
            { Name: "xml-trinidad", RuleType: "standard", Level: "", FileType: "xml$", Target: "line", Type: "regex", DefaultPattern: "(%s)", Advice: "Consider upgrading to modern UI framework", Effort: 10, Readiness: 7, Impact: "", Category: "trinidad", Criticality: "medium",Container: 50, Cloud: 50,
            Tags:
            ...
            { Name: "xml-weblogic", RuleType: "standard", Level: "", FileType: "xml$", Target: "file", Type: "simple-text", DefaultPattern: "", Advice: "Consider rearchitecting if decision is made to move off application server", Effort: 100, Readiness: 100, Impact: "", Category: "webLogic", Criticality: "medium",Container: 50, Cloud: 50,
            Tags:
            ...
            { Name: "xml-webprofile", RuleType: "standard", Level: "", FileType: "xml$", Target: "file", Type: "simple-text", DefaultPattern: "", Advice: "Consider rearchitecting if decision is made to move off application server", Effort: 50, Readiness: 1000, Impact: "", Category: "config", Criticality: "medium",Container: 50, Cloud: 50,
            Tags:
            ...
            { Name: "yaml-test", RuleType: "standard", Level: "", FileType: "(yaml|yml)$", Target: "file", Type: "yamlpath", DefaultPattern: "", Advice: "", Effort: 1000, Readiness: 10, Impact: "", Category: "", Criticality: "medium",Container: 50, Cloud: 50,
            Tags:
            []Tag{  },
            Profiles:
            []Profile{  { Value: "cloud-suitability",}, },
