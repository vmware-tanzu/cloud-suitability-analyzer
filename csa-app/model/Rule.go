...
type Rule struct {
	...
	CloudNativeReadiness int              `gorm:"type:bigint; column:cloud_native_readiness" json:",omitempty" yaml:",omitempty"`
	ContainerReadiness   int              `gorm:"type:bigint; column:container_readiness" json:",omitempty" yaml:",omitempty"`
